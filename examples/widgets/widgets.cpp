...
struct ButtonPage : public egt::NotebookTab
{
    ButtonPage()
    {
        auto grid0 = std::make_shared<egt::StaticGrid>(std::make_tuple(3, 6), 5);
        add(expand(grid0));
...
struct CheckBoxPage : public egt::NotebookTab
{
    CheckBoxPage()
    {
        auto grid0 = std::make_shared<egt::StaticGrid>(std::make_tuple(3, 10), 5);
...
struct LabelPage : public egt::NotebookTab
{
    LabelPage()
    {
        auto grid0 = std::make_shared<egt::StaticGrid>(std::make_tuple(3, 5), 5);
        add(egt::expand(grid0));
...
struct TextPage : public egt::NotebookTab
{
    TextPage()
    {
        auto grid1 = std::make_shared<egt::StaticGrid>(std::make_tuple(2, 1), 5);
        add(egt::expand(grid1));

        auto grid0 = std::make_shared<egt::StaticGrid>(std::make_tuple(1, 10), 5);
...
{
    auto animationup = std::make_shared<egt::PropertyAnimator>(0, 100, std::chrono::seconds(5), egt::easing_circular_easein);
    animationup->on_change([widget](egt::PropertyAnimator::Value value) { widget->value(value); });

    auto animationdown = std::make_shared<egt::PropertyAnimator>(100, 0, std::chrono::seconds(5), egt::easing_circular_easeout);
