...
#ifndef EGT_ASIO_USES_EXECUTOR_HPP
#define EGT_ASIO_USES_EXECUTOR_HPP
...
{
  /// Constructor.
  EGT_ASIO_CONSTEXPR executor_arg_t() EGT_ASIO_NOEXCEPT
  {
  }
};
...
/**
 * See egt::asio::executor_arg_t and egt::asio::uses_executor
...
#endif // EGT_ASIO_USES_EXECUTOR_HPP
