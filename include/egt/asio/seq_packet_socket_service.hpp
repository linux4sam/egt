...
#ifndef EGT_ASIO_SEQ_PACKET_SOCKET_SERVICE_HPP
#define EGT_ASIO_SEQ_PACKET_SOCKET_SERVICE_HPP
...
public:
  ...
  /// io_context.
  explicit seq_packet_socket_service(egt::asio::io_context& io_context)
  ...
  {
    if (protocol.type() == EGT_ASIO_OS_DEF(SOCK_SEQPACKET))
...
#endif // EGT_ASIO_SEQ_PACKET_SOCKET_SERVICE_HPP
