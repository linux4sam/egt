...
#ifndef EGT_ASIO_EXPERIMENTAL_CO_SPAWN_HPP
#define EGT_ASIO_EXPERIMENTAL_CO_SPAWN_HPP
...
#if defined(EGT_ASIO_HAS_CO_AWAIT) || defined(GENERATING_DOCUMENTATION)
...
#include <egt/asio/experimental/impl/co_spawn.hpp>

#endif // defined(EGT_ASIO_HAS_CO_AWAIT) || defined(GENERATING_DOCUMENTATION)

#endif // EGT_ASIO_EXPERIMENTAL_CO_SPAWN_HPP
