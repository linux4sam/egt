...
#ifndef EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
#define EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(win_iocp_socket_recvfrom_op);
...
#endif // EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
