...
#ifndef EGT_ASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
#define EGT_ASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(win_iocp_handle_read_op);
...
#endif // EGT_ASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
