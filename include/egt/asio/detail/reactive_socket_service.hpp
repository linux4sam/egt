...
#ifndef EGT_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
#define EGT_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
...
#include <egt/asio/detail/reactive_socket_accept_op.hpp>
#include <egt/asio/detail/reactive_socket_connect_op.hpp>
#include <egt/asio/detail/reactive_socket_recvfrom_op.hpp>
#include <egt/asio/detail/reactive_socket_sendto_op.hpp>
#include <egt/asio/detail/reactive_socket_service_base.hpp>
...
public:
  ...
  // Constructor.
  reactive_socket_service(egt::asio::io_context& io_context)
  ...
  egt::asio::error_code open(implementation_type& impl,
  ...
  egt::asio::error_code assign(implementation_type& impl,
  ...
  egt::asio::error_code bind(implementation_type& impl,
  ...
  egt::asio::error_code set_option(implementation_type& impl,
      const Option& option, egt::asio::error_code& ec)
  {
  ...
  // Set a socket option.
  template <typename Option>
  egt::asio::error_code get_option(const implementation_type& impl,
      Option& option, egt::asio::error_code& ec) const
  {
  ...
  egt::asio::error_code shutdown(base_implementation_type& impl,
  ...
  egt::asio::error_code accept(implementation_type& impl,
      Socket& peer, endpoint_type* peer_endpoint, egt::asio::error_code& ec)
  {
  ...
  void async_accept(implementation_type& impl,
      egt::asio::io_context* peer_io_context,
      endpoint_type* peer_endpoint, Handler& handler)
  {
    bool is_continuation =
      egt_asio_handler_cont_helpers::is_continuation(handler);
  ...
  egt::asio::error_code connect(implementation_type& impl,
...
#endif // EGT_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
