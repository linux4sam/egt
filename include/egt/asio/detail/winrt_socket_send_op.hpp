...
#ifndef EGT_ASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
#define EGT_ASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(winrt_socket_send_op);
...
#endif // EGT_ASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
