...
#ifndef EGT_ASIO_DETAIL_HANDLER_CONT_HELPERS_HPP
#define EGT_ASIO_DETAIL_HANDLER_CONT_HELPERS_HPP
...
// for that purpose.
namespace egt_asio_handler_cont_helpers {
...
inline bool is_continuation(Context& context)
{
  ...
  return false;
#else
  using egt::asio::asio_handler_is_continuation;
  return asio_handler_is_continuation(
      egt::asio::detail::addressof(context));
#endif
}
...
#endif // EGT_ASIO_DETAIL_HANDLER_CONT_HELPERS_HPP
