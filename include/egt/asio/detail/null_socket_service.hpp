...
#ifndef EGT_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
#define EGT_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
...
public:
  ...
  // Constructor.
  null_socket_service(egt::asio::io_context& io_context)
  ...
  egt::asio::error_code open(implementation_type&,
      const protocol_type&, egt::asio::error_code& ec)
  {
  ...
  egt::asio::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  egt::asio::error_code close(implementation_type&,
  ...
  egt::asio::error_code cancel(implementation_type&,
      egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  ...
  egt::asio::error_code listen(implementation_type&,
      int, egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  }
  ...
  egt::asio::error_code io_control(implementation_type&,
  ...
  egt::asio::error_code non_blocking(implementation_type&,
  ...
  egt::asio::error_code native_non_blocking(implementation_type&,
      bool, egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  ...
  egt::asio::error_code shutdown(implementation_type&,
  ...
  egt::asio::error_code bind(implementation_type&,
      const endpoint_type&, egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  }
  ...
  egt::asio::error_code set_option(implementation_type&,
      const Option&, egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  egt::asio::error_code get_option(const implementation_type&,
      Option&, egt::asio::error_code& ec) const
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  }
  ...
  egt::asio::error_code accept(implementation_type&,
      Socket&, endpoint_type*, egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
  }
  ...
  egt::asio::error_code connect(implementation_type&,
      const endpoint_type&, egt::asio::error_code& ec)
  {
    ec = egt::asio::error::operation_not_supported;
    return ec;
...
#endif // EGT_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
