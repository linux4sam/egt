...
#ifndef EGT_ASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
#define EGT_ASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(resolve_endpoint_op);
...
#endif // EGT_ASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
