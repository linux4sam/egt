...
#ifndef EGT_ASIO_DETAIL_WRAPPED_HANDLER_HPP
#define EGT_ASIO_DETAIL_WRAPPED_HANDLER_HPP
...
struct is_continuation_delegated
{
  ...
  {
    return egt_asio_handler_cont_helpers::is_continuation(handler);
  }
};
...
public:
  ...
  void operator()()
  {
    dispatcher_.dispatch(EGT_ASIO_MOVE_CAST(Handler)(handler_));
  }
...
public:
  ...
  rewrapped_handler(rewrapped_handler&& other)
    : context_(EGT_ASIO_MOVE_CAST(Context)(other.context_)),
      handler_(EGT_ASIO_MOVE_CAST(Handler)(other.handler_))
  {
  }
#endif // defined(EGT_ASIO_HAS_MOVE)
...
#endif // EGT_ASIO_DETAIL_WRAPPED_HANDLER_HPP
