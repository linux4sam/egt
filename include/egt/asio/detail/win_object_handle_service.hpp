...
#ifndef EGT_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
#define EGT_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
...
public:
  ...
  // Constructor.
  EGT_ASIO_DECL win_object_handle_service(
  ...
  EGT_ASIO_DECL void wait(implementation_type& impl,
      egt::asio::error_code& ec);
  ...
  void async_wait(implementation_type& impl, Handler& handler)
  {
    ...
    EGT_ASIO_HANDLER_CREATION((io_context_.context(), *p.p, "object_handle",
...
private:
  ...
  EGT_ASIO_DECL void start_wait_op(implementation_type& impl, wait_op* op);

  // Helper function to register a wait operation.
  EGT_ASIO_DECL void register_wait_callback(
      implementation_type& impl, mutex::scoped_lock& lock);

  // Callback function invoked when the registered wait completes.
  static EGT_ASIO_DECL VOID CALLBACK wait_callback(
...
#endif // EGT_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
