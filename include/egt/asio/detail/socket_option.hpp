...
#ifndef EGT_ASIO_DETAIL_SOCKET_OPTION_HPP
#define EGT_ASIO_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  {
    enabled(e);
    timeout EGT_ASIO_PREVENT_MACRO_SUBSTITUTION(t);
  }
  ...
  void timeout EGT_ASIO_PREVENT_MACRO_SUBSTITUTION(int value)
  {
#if defined(WIN32)
  ...
  int timeout EGT_ASIO_PREVENT_MACRO_SUBSTITUTION() const
  {
...
#endif // EGT_ASIO_DETAIL_SOCKET_OPTION_HPP
