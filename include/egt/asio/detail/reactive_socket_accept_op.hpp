...
#ifndef EGT_ASIO_DETAIL_REACTIVE_SOCKET_ACCEPT_OP_HPP
#define EGT_ASIO_DETAIL_REACTIVE_SOCKET_ACCEPT_OP_HPP
...
public:
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    EGT_ASIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_accept", o->ec_));
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(reactive_socket_accept_op);
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(reactive_socket_move_accept_op);
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      egt::asio::error_code, typename Protocol::socket>
        handler(0, EGT_ASIO_MOVE_CAST(Handler)(o->handler_), o->ec_,
          EGT_ASIO_MOVE_CAST(typename Protocol::socket)(*o));
    p.h = egt::asio::detail::addressof(handler.handler_);
    p.reset();
...
#endif // EGT_ASIO_DETAIL_REACTIVE_SOCKET_ACCEPT_OP_HPP
