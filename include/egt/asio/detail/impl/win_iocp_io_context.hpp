...
#ifndef EGT_ASIO_DETAIL_IMPL_WIN_IOCP_IO_CONTEXT_HPP
#define EGT_ASIO_DETAIL_IMPL_WIN_IOCP_IO_CONTEXT_HPP
...
{
  egt::asio::detail::mutex::scoped_lock lock(dispatch_mutex_);
...
#endif // EGT_ASIO_DETAIL_IMPL_WIN_IOCP_IO_CONTEXT_HPP
