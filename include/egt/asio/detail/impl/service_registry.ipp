...
#ifndef EGT_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
#define EGT_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
    ...
    execution_context::service* new_service)
{
  if (&owner_ != &new_service->context())
    egt::asio::detail::throw_exception(invalid_service_owner());
  ...
  {
    if (keys_match(service->key_, key))
      egt::asio::detail::throw_exception(service_already_exists());
    service = service->next_;
  }
...
#endif // EGT_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
