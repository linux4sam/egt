...
#ifndef EGT_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
#define EGT_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
...
void win_thread::start_thread(func_base* arg, unsigned int stack_size)
{
  ...
  if (!entry_event)
  {
    ...
    egt::asio::detail::throw_error(ec, "thread.entry_event");
  }
  ...
  if (!exit_event_)
  {
    ...
    egt::asio::error_code ec(last_error,
        egt::asio::error::get_system_category());
    egt::asio::detail::throw_error(ec, "thread.exit_event");
  }
...
#endif // EGT_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
