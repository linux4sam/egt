...
#ifndef EGT_ASIO_DETAIL_IMPL_EPOLL_REACTOR_IPP
#define EGT_ASIO_DETAIL_IMPL_EPOLL_REACTOR_IPP
...
epoll_reactor::epoll_reactor(egt::asio::execution_context& ctx)
  ...
  if (fork_ev == egt::asio::execution_context::fork_child)
  {
        ...
        state != 0; state = state->next_)
    {
      ...
      if (result != 0)
      {
        ...
        egt::asio::detail::throw_error(ec, "epoll re-registration");
      }
    }
  }
}
...
#else // defined(EGT_ASIO_HAS_TIMERFD)
...
int epoll_reactor::do_epoll_create()
{
  ...
  if (fd == -1)
  {
    egt::asio::error_code ec(errno,
        egt::asio::error::get_system_category());
    egt::asio::detail::throw_error(ec, "epoll");
  }
...
#endif // EGT_ASIO_DETAIL_IMPL_EPOLL_REACTOR_IPP
