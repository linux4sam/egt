...
#ifndef EGT_ASIO_DETAIL_IMPL_STRAND_SERVICE_IPP
#define EGT_ASIO_DETAIL_IMPL_STRAND_SERVICE_IPP
...
strand_service::strand_service(egt::asio::io_context& io_context)
  : egt::asio::detail::service_base<strand_service>(io_context),
...
#if defined(EGT_ASIO_ENABLE_SEQUENTIAL_STRAND_ALLOCATION)
  std::size_t index = salt;
#else // defined(EGT_ASIO_ENABLE_SEQUENTIAL_STRAND_ALLOCATION)
  std::size_t index = reinterpret_cast<std::size_t>(&impl);
  index += (reinterpret_cast<std::size_t>(&impl) >> 3);
  index ^= salt + 0x9e3779b9 + (index << 6) + (index >> 2);
#endif // defined(EGT_ASIO_ENABLE_SEQUENTIAL_STRAND_ALLOCATION)
...
#endif // EGT_ASIO_DETAIL_IMPL_STRAND_SERVICE_IPP
