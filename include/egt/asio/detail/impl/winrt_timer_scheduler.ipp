...
#ifndef EGT_ASIO_DETAIL_IMPL_WINRT_TIMER_SCHEDULER_IPP
#define EGT_ASIO_DETAIL_IMPL_WINRT_TIMER_SCHEDULER_IPP
...
winrt_timer_scheduler::winrt_timer_scheduler(
  ...
  : egt::asio::detail::service_base<winrt_timer_scheduler>(io_context),
    ...
    shutdown_(false)
{
  thread_ = new egt::asio::detail::thread(
...
void winrt_timer_scheduler::notify_fork(egt::asio::io_context::fork_event)
{
}
...
#endif // EGT_ASIO_DETAIL_IMPL_WINRT_TIMER_SCHEDULER_IPP
