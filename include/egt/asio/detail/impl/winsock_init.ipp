...
#ifndef EGT_ASIO_DETAIL_IMPL_WINSOCK_INIT_IPP
#define EGT_ASIO_DETAIL_IMPL_WINSOCK_INIT_IPP
...
void winsock_init_base::throw_on_error(data& d)
{
  ...
  if (result != 0)
  {
    egt::asio::error_code ec(result,
        egt::asio::error::get_system_category());
    egt::asio::detail::throw_error(ec, "winsock");
  }
}
...
#endif // EGT_ASIO_DETAIL_IMPL_WINSOCK_INIT_IPP
