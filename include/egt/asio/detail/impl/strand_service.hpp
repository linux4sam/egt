...
#ifndef EGT_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
#define EGT_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
    ...
    Handler& handler)
{
  ...
  EGT_ASIO_HANDLER_CREATION((this->context(),
  ...
  if (dispatch_immediately)
  {
    ...
    completion_handler<Handler>::do_complete(
        &io_context_, o, egt::asio::error_code(), 0);
  }
}
...
#endif // EGT_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
