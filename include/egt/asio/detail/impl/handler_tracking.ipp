...
#ifndef EGT_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
#define EGT_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
...
#include <cstdarg>
#include <cstdio>
#include <egt/asio/detail/handler_tracking.hpp>

#if defined(EGT_ASIO_HAS_BOOST_DATE_TIME)
# include <egt/asio/time_traits.hpp>
#elif defined(EGT_ASIO_HAS_CHRONO)
...
struct handler_tracking_timestamp
{
  ...
  handler_tracking_timestamp()
  {
    ...
    typedef chrono_time_traits<chrono::system_clock,
        egt::asio::wait_traits<chrono::system_clock> > traits_helper;
...
{
  static tracking_state state = { EGT_ASIO_STATIC_MUTEX_INIT, 1, 0 };
  return &state;
}
...
#endif // EGT_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
