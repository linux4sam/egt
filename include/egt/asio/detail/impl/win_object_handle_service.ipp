...
#ifndef EGT_ASIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
#define EGT_ASIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
...
#include <egt/asio/detail/win_object_handle_service.hpp>
    ...
    win_object_handle_service::implementation_type& impl)
{
  ...
  if (is_open(impl))
  {
    EGT_ASIO_HANDLER_OPERATION((io_context_.context(), "object_handle",
...
egt::asio::error_code win_object_handle_service::assign(
    win_object_handle_service::implementation_type& impl,
...
egt::asio::error_code win_object_handle_service::close(
    win_object_handle_service::implementation_type& impl,
...
egt::asio::error_code win_object_handle_service::cancel(
    win_object_handle_service::implementation_type& impl,
    egt::asio::error_code& ec)
{
  if (is_open(impl))
...
#endif // EGT_ASIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
