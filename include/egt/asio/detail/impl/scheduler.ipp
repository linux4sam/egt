...
#ifndef EGT_ASIO_DETAIL_IMPL_SCHEDULER_IPP
#define EGT_ASIO_DETAIL_IMPL_SCHEDULER_IPP
...
#include <egt/asio/detail/scheduler_thread_info.hpp>
...
scheduler::scheduler(
  ...
  : egt::asio::detail::execution_context_service_base<scheduler>(ctx),
    one_thread_(concurrency_hint == 1
        || !EGT_ASIO_CONCURRENCY_HINT_IS_LOCKING(
...
std::size_t scheduler::run(egt::asio::error_code& ec)
{
...
std::size_t scheduler::run_one(egt::asio::error_code& ec)
{
  ec = egt::asio::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::wait_one(long usec, egt::asio::error_code& ec)
{
  ec = egt::asio::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::poll(egt::asio::error_code& ec)
{
  ec = egt::asio::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::poll_one(egt::asio::error_code& ec)
{
  ec = egt::asio::error_code();
  if (outstanding_work_ == 0)
  {
...
#else // defined(EGT_ASIO_HAS_THREADS)
...
#endif // EGT_ASIO_DETAIL_IMPL_SCHEDULER_IPP
