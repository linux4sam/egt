...
#ifndef EGT_ASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
#define EGT_ASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
    ...
    reactive_socket_service_base::base_implementation_type& impl)
{
  ...
  {
    EGT_ASIO_HANDLER_OPERATION((reactor_.context(),
...
egt::asio::error_code reactive_socket_service_base::close(
    reactive_socket_service_base::base_implementation_type& impl,
...
egt::asio::error_code reactive_socket_service_base::cancel(
    reactive_socket_service_base::base_implementation_type& impl,
    egt::asio::error_code& ec)
{
  if (!is_open(impl))
...
egt::asio::error_code reactive_socket_service_base::do_open(
    reactive_socket_service_base::base_implementation_type& impl,
    int af, int type, int protocol, egt::asio::error_code& ec)
{
  if (is_open(impl))
  {
...
egt::asio::error_code reactive_socket_service_base::do_assign(
    ...
    reactor_op* op, bool is_continuation, bool peer_is_open)
{
  ...
  {
    op->ec_ = egt::asio::error::already_open;
    reactor_.post_immediate_completion(op, is_continuation);
  }
}
...
#endif // EGT_ASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
