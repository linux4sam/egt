...
#ifndef EGT_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
#define EGT_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
...
egt::asio::error_code reactive_descriptor_service::assign(
    reactive_descriptor_service::implementation_type& impl,
    const native_handle_type& native_descriptor, egt::asio::error_code& ec)
{
  if (is_open(impl))
  {
...
egt::asio::error_code reactive_descriptor_service::close(
    reactive_descriptor_service::implementation_type& impl,
...
egt::asio::error_code reactive_descriptor_service::cancel(
    reactive_descriptor_service::implementation_type& impl,
    egt::asio::error_code& ec)
{
  if (!is_open(impl))
...
#endif // EGT_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
