...
#ifndef EGT_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
#define EGT_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
...
select_reactor::select_reactor(egt::asio::execution_context& ctx)
...
{
#if defined(EGT_ASIO_HAS_IOCP)
  egt::asio::detail::signal_blocker sb;
  thread_ = new egt::asio::detail::thread(thread_function(this));
#endif // defined(EGT_ASIO_HAS_IOCP)
}
...
#endif // EGT_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
