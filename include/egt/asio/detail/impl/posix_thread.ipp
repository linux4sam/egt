...
#ifndef EGT_ASIO_DETAIL_IMPL_POSIX_THREAD_IPP
#define EGT_ASIO_DETAIL_IMPL_POSIX_THREAD_IPP
...
void posix_thread::start_thread(func_base* arg)
{
  int error = ::pthread_create(&thread_, 0,
        egt_asio_detail_posix_thread_function, arg);
  if (error != 0)
  {
    delete arg;
...
void* egt_asio_detail_posix_thread_function(void* arg)
{
...
#endif // EGT_ASIO_DETAIL_IMPL_POSIX_THREAD_IPP
