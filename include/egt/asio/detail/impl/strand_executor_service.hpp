...
#ifndef EGT_ASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
#define EGT_ASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
...
public:
  ...
  invoker(invoker&& other)
    : impl_(EGT_ASIO_MOVE_CAST(implementation_type)(other.impl_)),
      work_(EGT_ASIO_MOVE_CAST(executor_work_guard<Executor>)(other.work_))
  {
  }
  ...
  struct on_invoker_exit
  {
    ...
    ~on_invoker_exit()
    {
      ...
      if (more_handlers)
      {
        ...
        ex.post(EGT_ASIO_MOVE_CAST(invoker)(*this_), allocator);
      }
    }
  };
...
void strand_executor_service::dispatch(const implementation_type& impl,
    Executor& ex, EGT_ASIO_MOVE_ARG(Function) function, const Allocator& a)
{
  ...
  if (call_stack<strand_impl>::contains(impl.get()))
  {
    ...
    function_type tmp(EGT_ASIO_MOVE_CAST(Function)(function));
  ...
  p.p = new (p.v) op(EGT_ASIO_MOVE_CAST(Function)(function), a);

  EGT_ASIO_HANDLER_CREATION((impl->service_->context(), *p.p,
...
#endif // EGT_ASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
