...
#ifndef EGT_ASIO_DETAIL_RESOLVER_SERVICE_HPP
#define EGT_ASIO_DETAIL_RESOLVER_SERVICE_HPP
...
#include <egt/asio/detail/resolve_endpoint_op.hpp>
#include <egt/asio/detail/resolve_query_op.hpp>
...
public:
  ...
  // Constructor.
  resolver_service(egt::asio::io_context& io_context)
  ...
  void notify_fork(egt::asio::io_context::fork_event fork_ev)
  {
  ...
  {
    egt::asio::detail::addrinfo_type* address_info = 0;
      ...
      const query_type& query, Handler& handler)
  {
    ...
    EGT_ASIO_HANDLER_CREATION((io_context_impl_.context(),
...
#endif // EGT_ASIO_DETAIL_RESOLVER_SERVICE_HPP
