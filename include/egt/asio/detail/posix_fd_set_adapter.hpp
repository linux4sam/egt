...
#ifndef EGT_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
#define EGT_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
...
public:
  ...
  void set(reactor_op_queue<socket_type>& operations, op_queue<operation>& ops)
  {
    ...
    while (i != operations.end())
    {
      ...
      {
        egt::asio::error_code ec(error::fd_set_failure);
...
#endif // EGT_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
