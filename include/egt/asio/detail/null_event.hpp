...
#ifndef EGT_ASIO_DETAIL_NULL_EVENT_HPP
#define EGT_ASIO_DETAIL_NULL_EVENT_HPP
...
private:
  EGT_ASIO_DECL static void do_wait();
  EGT_ASIO_DECL static void do_wait_for_usec(long usec);
};
...
#endif // EGT_ASIO_DETAIL_NULL_EVENT_HPP
