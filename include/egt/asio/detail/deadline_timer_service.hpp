...
#ifndef EGT_ASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
#define EGT_ASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
...
#include <egt/asio/detail/timer_queue.hpp>
#include <egt/asio/detail/timer_queue_ptime.hpp>
#include <egt/asio/detail/timer_scheduler.hpp>
#include <egt/asio/detail/wait_handler.hpp>
...
public:
  ...
  // Constructor.
  deadline_timer_service(egt::asio::io_context& io_context)
    : service_base<deadline_timer_service<Time_Traits> >(io_context),
      scheduler_(egt::asio::use_service<timer_scheduler>(io_context))
  {
  ...
  std::size_t cancel(implementation_type& impl, egt::asio::error_code& ec)
  {
    if (!impl.might_have_pending_waits)
    {
    ...
    EGT_ASIO_HANDLER_OPERATION((scheduler_.context(),
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, egt::asio::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration_type& expiry_time, egt::asio::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, egt::asio::error_code& ec)
  {
  ...
  void async_wait(implementation_type& impl, Handler& handler)
  {
    ...
    EGT_ASIO_HANDLER_CREATION((scheduler_.context(),
...
private:
  ...
  void do_wait(const Duration& timeout, egt::asio::error_code& ec)
  {
#if defined(EGT_ASIO_WINDOWS_RUNTIME)
...
#endif // EGT_ASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
