...
#ifndef EGT_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
#define EGT_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
...
public:
  ...
  EGT_ASIO_DECL reactive_serial_port_service(
  ...
  egt::asio::error_code send_break(implementation_type& impl,
      egt::asio::error_code& ec)
  {
    errno = 0;
...
#endif // EGT_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
