...
#ifndef EGT_ASIO_DETAIL_REACTIVE_SOCKET_CONNECT_OP_HPP
#define EGT_ASIO_DETAIL_REACTIVE_SOCKET_CONNECT_OP_HPP
...
public:
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    EGT_ASIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_connect", o->ec_));
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(reactive_socket_connect_op);
...
#endif // EGT_ASIO_DETAIL_REACTIVE_SOCKET_CONNECT_OP_HPP
