...
#ifndef EGT_ASIO_DETAIL_KQUEUE_REACTOR_HPP
#define EGT_ASIO_DETAIL_KQUEUE_REACTOR_HPP
...
public:
  ...
  // Constructor.
  EGT_ASIO_DECL kqueue_reactor(egt::asio::execution_context& ctx);

  // Destructor.
  EGT_ASIO_DECL ~kqueue_reactor();
...
private:
  ...
  // cannot be created.
  EGT_ASIO_DECL static int do_kqueue_create();
  ...
  EGT_ASIO_DECL timespec* get_timeout(long usec, timespec& ts);
...
#include <egt/asio/detail/impl/kqueue_reactor.hpp>
...
#endif // EGT_ASIO_DETAIL_KQUEUE_REACTOR_HPP
