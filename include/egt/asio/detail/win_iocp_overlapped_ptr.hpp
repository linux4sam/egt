...
#ifndef EGT_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
#define EGT_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
...
#include <egt/asio/detail/win_iocp_overlapped_op.hpp>
...
public:
  ...
  explicit win_iocp_overlapped_ptr(
      egt::asio::io_context& io_context, EGT_ASIO_MOVE_ARG(Handler) handler)
    : ptr_(0),
      iocp_service_(0)
  {
    this->reset(io_context, EGT_ASIO_MOVE_CAST(Handler)(handler));
  }
  ...
  // object.
  template <typename Handler>
  void reset(egt::asio::io_context& io_context, Handler handler)
  {
    ...
    EGT_ASIO_HANDLER_CREATION((io_context, *p.p,
...
#endif // EGT_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
