...
#ifndef EGT_ASIO_DETAIL_BIND_HANDLER_HPP
#define EGT_ASIO_DETAIL_BIND_HANDLER_HPP
...
public:
  template <typename T>
  binder1(int, EGT_ASIO_MOVE_ARG(T) handler, const Arg1& arg1)
    : handler_(EGT_ASIO_MOVE_CAST(T)(handler)),
      arg1_(arg1)
  {
  }
  ...
  binder1(binder1&& other)
    : handler_(EGT_ASIO_MOVE_CAST(Handler)(other.handler_)),
      arg1_(EGT_ASIO_MOVE_CAST(Arg1)(other.arg1_))
  {
  }
...
inline binder1<typename decay<Handler>::type, Arg1> bind_handler(
    EGT_ASIO_MOVE_ARG(Handler) handler, const Arg1& arg1)
{
  return binder1<typename decay<Handler>::type, Arg1>(0,
      EGT_ASIO_MOVE_CAST(Handler)(handler), arg1);
}
...
public:
  template <typename T>
  binder2(int, EGT_ASIO_MOVE_ARG(T) handler,
  ...
  binder2(binder2&& other)
    : handler_(EGT_ASIO_MOVE_CAST(Handler)(other.handler_)),
      arg1_(EGT_ASIO_MOVE_CAST(Arg1)(other.arg1_)),
      arg2_(EGT_ASIO_MOVE_CAST(Arg2)(other.arg2_))
  {
  }
#endif // defined(EGT_ASIO_HAS_MOVE)
...
inline binder2<typename decay<Handler>::type, Arg1, Arg2> bind_handler(
    EGT_ASIO_MOVE_ARG(Handler) handler, const Arg1& arg1, const Arg2& arg2)
{
  return binder2<typename decay<Handler>::type, Arg1, Arg2>(0,
      EGT_ASIO_MOVE_CAST(Handler)(handler), arg1, arg2);
}
...
public:
  template <typename T>
  binder3(int, EGT_ASIO_MOVE_ARG(T) handler, const Arg1& arg1,
  ...
  binder3(binder3&& other)
    : handler_(EGT_ASIO_MOVE_CAST(Handler)(other.handler_)),
      arg1_(EGT_ASIO_MOVE_CAST(Arg1)(other.arg1_)),
      arg2_(EGT_ASIO_MOVE_CAST(Arg2)(other.arg2_)),
      arg3_(EGT_ASIO_MOVE_CAST(Arg3)(other.arg3_))
  {
  }
#endif // defined(EGT_ASIO_HAS_MOVE)
    ...
    const Arg3& arg3)
{
  return binder3<typename decay<Handler>::type, Arg1, Arg2, Arg3>(0,
      EGT_ASIO_MOVE_CAST(Handler)(handler), arg1, arg2, arg3);
}
...
public:
  template <typename T>
  binder4(int, EGT_ASIO_MOVE_ARG(T) handler, const Arg1& arg1,
  ...
  binder4(binder4&& other)
    : handler_(EGT_ASIO_MOVE_CAST(Handler)(other.handler_)),
      ...
      arg2_(EGT_ASIO_MOVE_CAST(Arg2)(other.arg2_)),
      arg3_(EGT_ASIO_MOVE_CAST(Arg3)(other.arg3_)),
      arg4_(EGT_ASIO_MOVE_CAST(Arg4)(other.arg4_))
  {
  }
#endif // defined(EGT_ASIO_HAS_MOVE)
...
bind_handler(EGT_ASIO_MOVE_ARG(Handler) handler, const Arg1& arg1,
    const Arg2& arg2, const Arg3& arg3, const Arg4& arg4)
{
  return binder4<typename decay<Handler>::type, Arg1, Arg2, Arg3, Arg4>(0,
      EGT_ASIO_MOVE_CAST(Handler)(handler), arg1, arg2, arg3, arg4);
}
...
public:
  template <typename T>
  binder5(int, EGT_ASIO_MOVE_ARG(T) handler, const Arg1& arg1,
  ...
  binder5(binder5&& other)
    : handler_(EGT_ASIO_MOVE_CAST(Handler)(other.handler_)),
      ...
      arg3_(EGT_ASIO_MOVE_CAST(Arg3)(other.arg3_)),
      arg4_(EGT_ASIO_MOVE_CAST(Arg4)(other.arg4_)),
      arg5_(EGT_ASIO_MOVE_CAST(Arg5)(other.arg5_))
  {
  }
#endif // defined(EGT_ASIO_HAS_MOVE)
    ...
    const Arg2& arg2, const Arg3& arg3, const Arg4& arg4, const Arg5& arg5)
{
  return binder5<typename decay<Handler>::type, Arg1, Arg2, Arg3, Arg4, Arg5>(0,
      EGT_ASIO_MOVE_CAST(Handler)(handler), arg1, arg2, arg3, arg4, arg5);
}
...
{
public:
  move_binder1(int, EGT_ASIO_MOVE_ARG(Handler) handler,
      EGT_ASIO_MOVE_ARG(Arg1) arg1)
    : handler_(EGT_ASIO_MOVE_CAST(Handler)(handler)),
      arg1_(EGT_ASIO_MOVE_CAST(Arg1)(arg1))
  {
  }
  ...
  void operator()()
  {
    handler_(EGT_ASIO_MOVE_CAST(Arg1)(arg1_));
  }
...
template <typename Function, typename Handler, typename Arg1>
inline void asio_handler_invoke(EGT_ASIO_MOVE_ARG(Function) function,
    move_binder1<Handler, Arg1>* this_handler)
{
  egt_asio_handler_invoke_helpers::invoke(
      EGT_ASIO_MOVE_CAST(Function)(function), this_handler->handler_);
}
...
{
public:
  move_binder2(int, EGT_ASIO_MOVE_ARG(Handler) handler,
      const Arg1& arg1, EGT_ASIO_MOVE_ARG(Arg2) arg2)
    : handler_(EGT_ASIO_MOVE_CAST(Handler)(handler)),
      arg1_(arg1),
      arg2_(EGT_ASIO_MOVE_CAST(Arg2)(arg2))
  {
  }
...
#endif // EGT_ASIO_DETAIL_BIND_HANDLER_HPP
