...
#ifndef EGT_ASIO_DETAIL_WAIT_HANDLER_HPP
#define EGT_ASIO_DETAIL_WAIT_HANDLER_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(wait_handler);
...
#endif // EGT_ASIO_DETAIL_WAIT_HANDLER_HPP
