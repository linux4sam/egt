...
#ifndef EGT_ASIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
#define EGT_ASIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
...
#include <egt/asio/detail/winrt_resolve_op.hpp>
...
public:
  ...
  // Constructor.
  winrt_resolver_service(egt::asio::io_context& io_context)
  ...
  void notify_fork(egt::asio::io_context::fork_event)
  {
  }
  ...
  results_type resolve(implementation_type&,
      const query_type& query, egt::asio::error_code& ec)
  {
    try
    {
...
#endif // EGT_ASIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
