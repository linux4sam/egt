...
#ifndef EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
#define EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
...
#include <egt/asio/detail/win_iocp_socket_accept_op.hpp>
#include <egt/asio/detail/win_iocp_socket_connect_op.hpp>
#include <egt/asio/detail/win_iocp_socket_recvfrom_op.hpp>
...
public:
  ...
  // Constructor.
  win_iocp_socket_service(egt::asio::io_context& io_context)
  ...
  egt::asio::error_code accept(implementation_type& impl, Socket& peer,
...
#endif // EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
