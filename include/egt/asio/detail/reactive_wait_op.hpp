...
#ifndef EGT_ASIO_DETAIL_REACTIVE_WAIT_OP_HPP
#define EGT_ASIO_DETAIL_REACTIVE_WAIT_OP_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(reactive_wait_op);
...
#endif // EGT_ASIO_DETAIL_REACTIVE_WAIT_OP_HPP
