...
#ifndef EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
#define EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
...
#include <egt/asio/detail/socket_holder.hpp>
...
#include <egt/asio/detail/win_iocp_null_buffers_op.hpp>
#include <egt/asio/detail/win_iocp_socket_connect_op.hpp>
#include <egt/asio/detail/win_iocp_socket_send_op.hpp>
#include <egt/asio/detail/win_iocp_socket_recv_op.hpp>
#include <egt/asio/detail/win_iocp_socket_recvmsg_op.hpp>
#include <egt/asio/detail/win_iocp_wait_op.hpp>
...
public:
...
#if defined(EGT_ASIO_ENABLE_CANCELIO)
    // The ID of the thread from which it is safe to cancel asynchronous
    // operations. 0 means no asynchronous operations have been started yet.
    // ~0 means asynchronous operations have been started from more than one
    // thread, and cancellation is not supported for the socket.
    DWORD safe_cancellation_thread_id_;
#endif // defined(EGT_ASIO_ENABLE_CANCELIO)
  ...
  // Constructor.
  EGT_ASIO_DECL win_iocp_socket_service_base(
  ...
  EGT_ASIO_DECL void construct(base_implementation_type& impl);
  ...
  EGT_ASIO_DECL socket_type release(
      base_implementation_type& impl, egt::asio::error_code& ec);

  // Cancel all operations associated with the socket.
  EGT_ASIO_DECL egt::asio::error_code cancel(
      base_implementation_type& impl, egt::asio::error_code& ec);
  ...
  egt::asio::error_code listen(base_implementation_type& impl,
  ...
  egt::asio::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, egt::asio::error_code& ec)
  {
  ...
  egt::asio::error_code non_blocking(base_implementation_type& impl,
  ...
  egt::asio::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, egt::asio::error_code& ec)
  {
  ...
  egt::asio::error_code wait(base_implementation_type& impl,
      ...
      socket_base::wait_type w, Handler& handler)
  {
    ...
    EGT_ASIO_HANDLER_CREATION((io_context_, *p.p, "socket",
    ...
    switch (w)
    {
      ...
      case socket_base::wait_error:
        ...
        break;
      default:
        p.p->ec_ = egt::asio::error::invalid_argument;
  ...
  size_t receive_with_flags(base_implementation_type& impl,
      ...
      socket_base::message_flags& out_flags, egt::asio::error_code& ec)
  {
    buffer_sequence_adapter<egt::asio::mutable_buffer,
        MutableBufferSequence> bufs(buffers);
  ...
  EGT_ASIO_DECL void restart_accept_op(socket_type s,
      socket_holder& new_socket, int family, int type, int protocol,
      void* output_buffer, DWORD address_length, operation* op);

protected:
  // Open a new socket implementation.
  EGT_ASIO_DECL egt::asio::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, egt::asio::error_code& ec);

  // Assign a native socket to a socket implementation.
  EGT_ASIO_DECL egt::asio::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, egt::asio::error_code& ec);
  ...
  EGT_ASIO_DECL void start_send_to_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count,
  ...
  EGT_ASIO_DECL void start_null_buffers_receive_op(
      base_implementation_type& impl,
      socket_base::message_flags flags, reactor_op* op);

  // Helper function to start an asynchronous receive_from operation.
  EGT_ASIO_DECL void start_receive_from_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count, socket_addr_type* addr,
      socket_base::message_flags flags, int* addrlen, operation* op);

  // Helper function to start an asynchronous accept operation.
  EGT_ASIO_DECL void start_accept_op(base_implementation_type& impl,
      bool peer_is_open, socket_holder& new_socket, int family, int type,
      int protocol, void* output_buffer, DWORD address_length, operation* op);

  // Start an asynchronous read or write operation using the reactor.
  EGT_ASIO_DECL void start_reactor_op(base_implementation_type& impl,
      int op_type, reactor_op* op);

  // Start the asynchronous connect operation using the reactor.
  EGT_ASIO_DECL void start_connect_op(base_implementation_type& impl,
  ...
  // destroyed.
  EGT_ASIO_DECL void close_for_destruction(base_implementation_type& impl);

  // Update the ID of the thread from which cancellation is safe.
  EGT_ASIO_DECL void update_cancellation_thread_id(
      base_implementation_type& impl);
  ...
  // this service.
  EGT_ASIO_DECL select_reactor& get_reactor();
  ...
  EGT_ASIO_DECL connect_ex_fn get_connect_ex(
      base_implementation_type& impl, int type);
  ...
  EGT_ASIO_DECL nt_set_info_fn get_nt_set_info();

  // Helper function to emulate InterlockedCompareExchangePointer functionality
  // for:
  // - very old Platform SDKs; and
  // - platform SDKs where MSVC's /Wp64 option causes spurious warnings.
  EGT_ASIO_DECL void* interlocked_compare_exchange_pointer(
      void** dest, void* exch, void* cmp);

  // Helper function to emulate InterlockedExchangePointer functionality for:
  // - very old Platform SDKs; and
  // - platform SDKs where MSVC's /Wp64 option causes spurious warnings.
  EGT_ASIO_DECL void* interlocked_exchange_pointer(void** dest, void* val);
...
#endif // EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
