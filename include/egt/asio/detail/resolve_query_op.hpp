...
#ifndef EGT_ASIO_DETAIL_RESOLVE_QUERY_OP_HPP
#define EGT_ASIO_DETAIL_RESOLVE_QUERY_OP_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(resolve_query_op);
...
private:
  ...
  Handler handler_;
  egt::asio::detail::addrinfo_type* addrinfo_;
};
...
#endif // EGT_ASIO_DETAIL_RESOLVE_QUERY_OP_HPP
