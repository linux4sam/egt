...
#ifndef EGT_ASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
#define EGT_ASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
...
#include <egt/asio/detail/win_iocp_handle_read_op.hpp>
#include <egt/asio/detail/win_iocp_handle_write_op.hpp>
...
public:
  ...
  EGT_ASIO_DECL win_iocp_handle_service(egt::asio::io_context& io_context);
      ...
      const ConstBufferSequence& buffers, Handler& handler)
  {
    ...
    EGT_ASIO_HANDLER_CREATION((iocp_service_.context(), *p.p, "handle", &impl,
...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, egt::asio::error_code& ec);
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const null_buffers& buffers, egt::asio::error_code& ec);
  ...
  EGT_ASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const egt::asio::const_buffer& buffer,
      egt::asio::error_code& ec);

  // Helper function to start a write operation.
  EGT_ASIO_DECL void start_write_op(implementation_type& impl,
      uint64_t offset, const egt::asio::const_buffer& buffer,
      operation* op);

  // Helper function to perform a synchronous write operation.
  EGT_ASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const egt::asio::mutable_buffer& buffer,
      egt::asio::error_code& ec);

  // Helper function to start a read operation.
  EGT_ASIO_DECL void start_read_op(implementation_type& impl,
      uint64_t offset, const egt::asio::mutable_buffer& buffer,
      operation* op);

  // Update the ID of the thread from which cancellation is safe.
  EGT_ASIO_DECL void update_cancellation_thread_id(implementation_type& impl);

  // Helper function to close a handle when the associated object is being
  // destroyed.
  EGT_ASIO_DECL void close_for_destruction(implementation_type& impl);
...
#endif // EGT_ASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
