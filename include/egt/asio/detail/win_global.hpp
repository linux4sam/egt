...
#ifndef EGT_ASIO_DETAIL_WIN_GLOBAL_HPP
#define EGT_ASIO_DETAIL_WIN_GLOBAL_HPP
...
template <typename T>
static_mutex win_global_impl<T>::mutex_ = EGT_ASIO_STATIC_MUTEX_INIT;
...
#endif // EGT_ASIO_DETAIL_WIN_GLOBAL_HPP
