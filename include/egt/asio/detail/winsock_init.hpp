...
#ifndef EGT_ASIO_DETAIL_WINSOCK_INIT_HPP
#define EGT_ASIO_DETAIL_WINSOCK_INIT_HPP
...
protected:
  ...
  EGT_ASIO_DECL static void startup(data& d,
      unsigned char major, unsigned char minor);

  EGT_ASIO_DECL static void manual_startup(data& d);

  EGT_ASIO_DECL static void cleanup(data& d);

  EGT_ASIO_DECL static void manual_cleanup(data& d);

  EGT_ASIO_DECL static void throw_on_error(data& d);
};
...
public:
  ...
  //   #pragma init_seg(lib)
  //   egt::asio::detail::winsock_init<>::manual manual_winsock_init;
  //   #pragma warning(pop)
  class manual
  {
  public:
...
#endif // EGT_ASIO_DETAIL_WINSOCK_INIT_HPP
