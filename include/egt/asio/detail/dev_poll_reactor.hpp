...
#ifndef EGT_ASIO_DETAIL_DEV_POLL_REACTOR_HPP
#define EGT_ASIO_DETAIL_DEV_POLL_REACTOR_HPP
...
#include <egt/asio/detail/hash_map.hpp>
...
public:
  ...
  // Constructor.
  EGT_ASIO_DECL dev_poll_reactor(egt::asio::execution_context& ctx);

  // Destructor.
  EGT_ASIO_DECL ~dev_poll_reactor();
...
private:
  ...
  // cannot be created.
  EGT_ASIO_DECL static int do_dev_poll_create();
  ...
  EGT_ASIO_DECL ::pollfd& add_pending_event_change(int descriptor);
...
#include <egt/asio/detail/impl/dev_poll_reactor.hpp>
...
#endif // EGT_ASIO_DETAIL_DEV_POLL_REACTOR_HPP
