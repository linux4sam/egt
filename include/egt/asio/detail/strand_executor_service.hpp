...
#ifndef EGT_ASIO_DETAIL_STRAND_EXECUTOR_SERVICE_HPP
#define EGT_ASIO_DETAIL_STRAND_EXECUTOR_SERVICE_HPP
...
public:
  ...
  EGT_ASIO_DECL static bool running_in_this_thread(
...
private:
  ...
  EGT_ASIO_DECL static bool enqueue(const implementation_type& impl,
...
#include <egt/asio/detail/impl/strand_executor_service.hpp>
...
#endif // EGT_ASIO_DETAIL_STRAND_EXECUTOR_SERVICE_HPP
