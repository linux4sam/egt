...
#ifndef EGT_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
#define EGT_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
...
#include <egt/asio/detail/descriptor_read_op.hpp>
#include <egt/asio/detail/descriptor_write_op.hpp>
...
public:
  ...
  // Constructor.
  EGT_ASIO_DECL reactive_descriptor_service(
  ...
  EGT_ASIO_DECL egt::asio::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  EGT_ASIO_DECL egt::asio::error_code close(implementation_type& impl,
      egt::asio::error_code& ec);
  ...
  EGT_ASIO_DECL native_handle_type release(implementation_type& impl);
  ...
  egt::asio::error_code io_control(implementation_type& impl,
  ...
  egt::asio::error_code non_blocking(implementation_type& impl,
  ...
  egt::asio::error_code native_non_blocking(implementation_type& impl,
      bool mode, egt::asio::error_code& ec)
  {
  ...
  egt::asio::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, egt::asio::error_code& ec)
  {
    switch (w)
    {
      ...
      posix::descriptor_base::wait_type w, Handler& handler)
  {
    ...
    EGT_ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "descriptor",
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, egt::asio::error_code& ec)
  {
...
private:
  ...
  EGT_ASIO_DECL void start_op(implementation_type& impl, int op_type,
...
#endif // EGT_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
