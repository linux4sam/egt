...
#ifndef EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
#define EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(win_iocp_socket_accept_op);
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    if (owner)
    {
      ...
      if (ec == egt::asio::error::connection_aborted
...
{
public:
  EGT_ASIO_DEFINE_HANDLER_PTR(win_iocp_socket_move_accept_op);

  win_iocp_socket_move_accept_op(
      win_iocp_socket_service_base& socket_service, socket_type socket,
      const Protocol& protocol, egt::asio::io_context& peer_io_context,
      typename Protocol::endpoint* peer_endpoint,
      bool enable_connection_aborted, Handler& handler)
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      egt::asio::error_code, typename Protocol::socket>
        handler(0, EGT_ASIO_MOVE_CAST(Handler)(o->handler_), ec,
          EGT_ASIO_MOVE_CAST(typename Protocol::socket)(o->peer_));
    p.h = egt::asio::detail::addressof(handler.handler_);
    p.reset();
...
#endif // EGT_ASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
