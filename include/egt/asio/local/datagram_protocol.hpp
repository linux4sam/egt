...
#ifndef EGT_ASIO_LOCAL_DATAGRAM_PROTOCOL_HPP
#define EGT_ASIO_LOCAL_DATAGRAM_PROTOCOL_HPP
...
/**
 * The egt::asio::local::datagram_protocol class contains flags necessary for
...
#endif // EGT_ASIO_LOCAL_DATAGRAM_PROTOCOL_HPP
