...
#ifndef EGT_ASIO_LOCAL_BASIC_ENDPOINT_HPP
#define EGT_ASIO_LOCAL_BASIC_ENDPOINT_HPP
...
/**
 * The egt::asio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  egt::asio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates egt::asio::local::basic_endpoint
 */
...
#endif // EGT_ASIO_LOCAL_BASIC_ENDPOINT_HPP
