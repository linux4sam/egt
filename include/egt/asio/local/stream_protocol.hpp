...
#ifndef EGT_ASIO_LOCAL_STREAM_PROTOCOL_HPP
#define EGT_ASIO_LOCAL_STREAM_PROTOCOL_HPP
...
/**
 * The egt::asio::local::stream_protocol class contains flags necessary for
...
#endif // EGT_ASIO_LOCAL_STREAM_PROTOCOL_HPP
