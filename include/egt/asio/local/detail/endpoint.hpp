...
#ifndef EGT_ASIO_LOCAL_DETAIL_ENDPOINT_HPP
#define EGT_ASIO_LOCAL_DETAIL_ENDPOINT_HPP
...
public:
  ...
  EGT_ASIO_DECL endpoint(const char* path_name);

  // Construct an endpoint using the specified path name.
  EGT_ASIO_DECL endpoint(const std::string& path_name);
  ...
  {
    return path_length_
      + offsetof(egt::asio::detail::sockaddr_un_type, sun_path);
  }

  // Set the underlying size of the endpoint in the native type.
  EGT_ASIO_DECL void resize(std::size_t size);

  // Get the capacity of the endpoint in the native type.
  std::size_t capacity() const
  {
    return sizeof(egt::asio::detail::sockaddr_un_type);
  }

  // Get the path associated with the endpoint.
  EGT_ASIO_DECL std::string path() const;

  // Set the path associated with the endpoint.
  EGT_ASIO_DECL void path(const char* p);

  // Set the path associated with the endpoint.
  EGT_ASIO_DECL void path(const std::string& p);
...
private:
  ...
  union data_union
  {
    ...
    egt::asio::detail::sockaddr_un_type local;
  } data_;
  ...
  EGT_ASIO_DECL void init(const char* path, std::size_t path_length);
};
...
#endif // EGT_ASIO_LOCAL_DETAIL_ENDPOINT_HPP
