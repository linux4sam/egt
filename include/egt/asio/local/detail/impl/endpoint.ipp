...
#ifndef EGT_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
#define EGT_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
...
#include <egt/asio/local/detail/endpoint.hpp>
...
{
  if (new_size > sizeof(egt::asio::detail::sockaddr_un_type))
  {
...
void endpoint::init(const char* path_name, std::size_t path_length)
{
  if (path_length > sizeof(data_.local.sun_path) - 1)
  {
    ...
    egt::asio::error_code ec(egt::asio::error::name_too_long);
    egt::asio::detail::throw_error(ec);
  }

  using namespace std; // For memcpy.
  data_.local = egt::asio::detail::sockaddr_un_type();
...
#endif // EGT_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
