...
#ifndef EGT_ASIO_SIGNAL_SET_HPP
#define EGT_ASIO_SIGNAL_SET_HPP
...
public:
   ...
   */
  signal_set(egt::asio::io_context& io_context, int signal_number_1)
    : basic_io_object<detail::signal_set_service>(io_context)
  {
   ...
   */
  EGT_ASIO_SYNC_OP_VOID add(int signal_number,
      egt::asio::error_code& ec)
  {
    this->get_service().add(this->get_implementation(), signal_number, ec);
