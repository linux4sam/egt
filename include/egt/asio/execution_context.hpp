...
#ifndef EGT_ASIO_EXECUTION_CONTEXT_HPP
#define EGT_ASIO_EXECUTION_CONTEXT_HPP
...
protected:
  /// Constructor.
  EGT_ASIO_DECL execution_context();
...
public:
   ...
   *
   * @throws egt::asio::system_error Thrown on failure. If the notification
   ...
   */
  EGT_ASIO_DECL void notify_fork(fork_event event);
   ...
   * constructor.
   *
   * @throws egt::asio::service_already_exists Thrown if a service of the
...
#undef EGT_ASIO_PRIVATE_MAKE_SERVICE_DEF
   ...
   * given type is already present in the execution_context.
   *
   * @throws egt::asio::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  egt::asio::detail::service_registry* service_registry_;
};
...
protected:
   ...
   */
  EGT_ASIO_DECL service(execution_context& owner);
...
private:
  ...
  friend class egt::asio::detail::service_registry;
  struct key
  {
...
{
public:
  EGT_ASIO_DECL service_already_exists();
};
...
{
public:
  EGT_ASIO_DECL invalid_service_owner();
};
