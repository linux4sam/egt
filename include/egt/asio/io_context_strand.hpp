...
#ifndef EGT_ASIO_IO_CONTEXT_STRAND_HPP
#define EGT_ASIO_IO_CONTEXT_STRAND_HPP
...
#include <egt/asio/detail/strand_service.hpp>
...
public:
   ...
   */
  explicit strand(egt::asio::io_context& io_context)
    : service_(egt::asio::use_service<
        egt::asio::detail::strand_service>(io_context))
  {
  ...
  egt::asio::io_context& context() const EGT_ASIO_NOEXCEPT
  {
    return service_.get_io_context();
  }
...
#if !defined(EGT_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use egt::asio::dispatch().) Request the strand to invoke
  /// the given handler.
  /**
...
#if !defined(EGT_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use egt::asio::post().) Request the strand to invoke the
...
private:
  egt::asio::detail::strand_service& service_;
  mutable egt::asio::detail::strand_service::implementation_type impl_;
};
...
#endif // EGT_ASIO_IO_CONTEXT_STRAND_HPP
