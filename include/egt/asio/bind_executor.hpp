...
#ifndef EGT_ASIO_BIND_EXECUTOR_HPP
#define EGT_ASIO_BIND_EXECUTOR_HPP
...
protected:
  ...
  executor_binder_base(EGT_ASIO_MOVE_ARG(E) e, EGT_ASIO_MOVE_ARG(U) u)
    : executor_(EGT_ASIO_MOVE_CAST(E)(e)),
      target_(executor_arg_t(), executor_, EGT_ASIO_MOVE_CAST(U)(u))
  {
  }
...
protected:
  ...
  executor_binder_base(EGT_ASIO_MOVE_ARG(E) e, EGT_ASIO_MOVE_ARG(U) u)
    : executor_(EGT_ASIO_MOVE_CAST(E)(e)),
      target_(EGT_ASIO_MOVE_CAST(U)(u))
  {
  }
...
public:
  ...
  executor_binder(executor_arg_t, const executor_type& e,
      EGT_ASIO_MOVE_ARG(U) u)
    : base_type(e, EGT_ASIO_MOVE_CAST(U)(u))
  {
  }
  ...
  executor_binder(executor_binder&& other)
    : base_type(EGT_ASIO_MOVE_CAST(executor_type)(other.get_executor()),
        EGT_ASIO_MOVE_CAST(T)(other.get()))
  {
  }
  ...
  executor_binder(executor_arg_t, const executor_type& e,
    ...
    : base_type(e, EGT_ASIO_MOVE_CAST(T)(other.get()))
  {
  }
  ...
  executor_binder(executor_binder<U, OtherExecutor>&& other)
    : base_type(EGT_ASIO_MOVE_CAST(OtherExecutor)(other.get_executor()),
        EGT_ASIO_MOVE_CAST(U)(other.get()))
  {
  }
  ...
  executor_binder(executor_arg_t, const executor_type& e,
    ...
    : base_type(e, EGT_ASIO_MOVE_CAST(U)(other.get()))
  {
  }
  ...
  target_type& get() EGT_ASIO_NOEXCEPT
  {
    return this->target_;
  }

  /// Obtain a reference to the target object.
  const target_type& get() const EGT_ASIO_NOEXCEPT
  {
    return this->target_;
  }
  ...
  {
    return this->target_(EGT_ASIO_MOVE_CAST(Args)(args)...);
  }

  /// Forwarding function call operator.
  template <typename... Args>
  typename result_of<T(Args...)>::type operator()(
      EGT_ASIO_MOVE_ARG(Args)... args) const
  {
    return this->target_(EGT_ASIO_MOVE_CAST(Args)(args)...);
  }

#elif defined(EGT_ASIO_HAS_STD_TYPE_TRAITS) && !defined(_MSC_VER)
...
#define EGT_ASIO_PRIVATE_BIND_EXECUTOR_CALL_DEF(n) \
  template <EGT_ASIO_VARIADIC_TPARAMS(n)> \
  typename result_of<T(EGT_ASIO_VARIADIC_TARGS(n))>::type operator()( \
      EGT_ASIO_VARIADIC_MOVE_PARAMS(n)) \
  { \
    return this->target_(EGT_ASIO_VARIADIC_MOVE_ARGS(n)); \
  } \
  \
  template <EGT_ASIO_VARIADIC_TPARAMS(n)> \
  typename result_of<T(EGT_ASIO_VARIADIC_TARGS(n))>::type operator()( \
      EGT_ASIO_VARIADIC_MOVE_PARAMS(n)) const \
  { \
    return this->target_(EGT_ASIO_VARIADIC_MOVE_ARGS(n)); \
  } \
  /**/
  EGT_ASIO_VARIADIC_GENERATE(EGT_ASIO_PRIVATE_BIND_EXECUTOR_CALL_DEF)
#undef EGT_ASIO_PRIVATE_BIND_EXECUTOR_CALL_DEF

#else // defined(EGT_ASIO_HAS_STD_TYPE_TRAITS) && !defined(_MSC_VER)
...
#endif // defined(EGT_ASIO_HAS_STD_TYPE_TRAITS) && !defined(_MSC_VER)
...
bind_executor(const Executor& ex, EGT_ASIO_MOVE_ARG(T) t,
    typename enable_if<is_executor<Executor>::value>::type* = 0)
{
  return executor_binder<typename decay<T>::type, Executor>(
      executor_arg_t(), ex, EGT_ASIO_MOVE_CAST(T)(t));
}
...
bind_executor(ExecutionContext& ctx, EGT_ASIO_MOVE_ARG(T) t,
    typename enable_if<is_convertible<
      ExecutionContext&, execution_context&>::value>::type* = 0)
{
  return executor_binder<typename decay<T>::type,
    typename ExecutionContext::executor_type>(
      executor_arg_t(), ctx.get_executor(), EGT_ASIO_MOVE_CAST(T)(t));
}
...
private:
  async_result(const async_result&) EGT_ASIO_DELETED;
  async_result& operator=(const async_result&) EGT_ASIO_DELETED;
...
struct associated_executor<executor_binder<T, Executor>, Executor1>
{
  ...
  static type get(const executor_binder<T, Executor>& b,
      const Executor1& = Executor1()) EGT_ASIO_NOEXCEPT
  {
...
#endif // EGT_ASIO_BIND_EXECUTOR_HPP
