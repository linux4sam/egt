...
#ifndef EGT_ASIO_GENERIC_STREAM_PROTOCOL_HPP
#define EGT_ASIO_GENERIC_STREAM_PROTOCOL_HPP
...
/**
 * The egt::asio::generic::stream_protocol class contains flags necessary for
 ...
 * @code stream_protocol p(egt::asio::ip::tcp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // EGT_ASIO_GENERIC_STREAM_PROTOCOL_HPP
