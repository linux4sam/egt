...
#ifndef EGT_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
#define EGT_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
...
/**
 * The egt::asio::generic::seq_packet_protocol class contains flags necessary
...
public:
  ...
  int type() const
  {
    return EGT_ASIO_OS_DEF(SOCK_SEQPACKET);
  }
...
#endif // EGT_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
