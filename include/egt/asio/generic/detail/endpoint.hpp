...
#ifndef EGT_ASIO_GENERIC_DETAIL_ENDPOINT_HPP
#define EGT_ASIO_GENERIC_DETAIL_ENDPOINT_HPP
...
public:
  ...
  EGT_ASIO_DECL endpoint(const void* sock_addr,
  ...
  {
    return sizeof(egt::asio::detail::sockaddr_storage_type);
  }
...
private:
  ...
  union data_union
  {
    ...
    egt::asio::detail::sockaddr_storage_type generic;
  } data_;
  ...
  EGT_ASIO_DECL void init(const void* sock_addr,
      std::size_t sock_addr_size, int sock_protocol);
};
...
#endif // EGT_ASIO_GENERIC_DETAIL_ENDPOINT_HPP
