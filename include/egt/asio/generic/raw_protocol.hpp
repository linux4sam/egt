...
#ifndef EGT_ASIO_GENERIC_RAW_PROTOCOL_HPP
#define EGT_ASIO_GENERIC_RAW_PROTOCOL_HPP
...
/**
 * The egt::asio::generic::raw_protocol class contains flags necessary for
 ...
 * @code raw_protocol p(egt::asio::ip::icmp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // EGT_ASIO_GENERIC_RAW_PROTOCOL_HPP
