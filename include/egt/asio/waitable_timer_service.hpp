...
#ifndef EGT_ASIO_WAITABLE_TIMER_SERVICE_HPP
#define EGT_ASIO_WAITABLE_TIMER_SERVICE_HPP
...
public:
  ...
  explicit waitable_timer_service(egt::asio::io_context& io_context)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, egt::asio::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration& expiry_time, egt::asio::error_code& ec)
  {
...
#endif // EGT_ASIO_WAITABLE_TIMER_SERVICE_HPP
