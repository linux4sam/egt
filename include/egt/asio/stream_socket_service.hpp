...
#ifndef EGT_ASIO_STREAM_SOCKET_SERVICE_HPP
#define EGT_ASIO_STREAM_SOCKET_SERVICE_HPP
...
#else
  : public egt::asio::detail::service_base<stream_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_socket_service(egt::asio::io_context& io_context)
  ...
  {
    if (protocol.type() == EGT_ASIO_OS_DEF(SOCK_STREAM))
...
#endif // EGT_ASIO_STREAM_SOCKET_SERVICE_HPP
