...
#ifndef EGT_ASIO_USE_FUTURE_HPP
#define EGT_ASIO_USE_FUTURE_HPP
 ...
 * egt::asio::use_future. For example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, egt::asio::use_future); @endcode
 *
...
public:
  ...
  EGT_ASIO_CONSTEXPR use_future_t()
  {
  }
   ...
   *     use_future([](egt::asio::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
  ...
  operator()(EGT_ASIO_MOVE_ARG(Function) f) const;
...
private:
  ...
  {
    EGT_ASIO_CONSTEXPR std_allocator_void()
    {
    }
...
/**
 * See the documentation for egt::asio::use_future_t for a usage example.
 */
#if defined(EGT_ASIO_HAS_CONSTEXPR) || defined(GENERATING_DOCUMENTATION)
...
#include <egt/asio/impl/use_future.hpp>

#endif // defined(EGT_ASIO_HAS_STD_FUTURE)
       //   || defined(GENERATING_DOCUMENTATION)

#endif // EGT_ASIO_USE_FUTURE_HPP
