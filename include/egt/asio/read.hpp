...
#ifndef EGT_ASIO_READ_HPP
#define EGT_ASIO_READ_HPP
 ...
 * @code egt::asio::read(s, egt::asio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::read(s, egt::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::read(s, egt::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read egt::asio::async_read
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * egt::asio::async_read(s, egt::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
#include <egt/asio/impl/read.hpp>

#endif // EGT_ASIO_READ_HPP
