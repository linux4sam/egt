...
#ifndef EGT_ASIO_IP_ADDRESS_V4_ITERATOR_HPP
#define EGT_ASIO_IP_ADDRESS_V4_ITERATOR_HPP
...
public:
  ...
  basic_address_iterator(const address_v4& addr) EGT_ASIO_NOEXCEPT
    : address_(addr)
  {
  }
  ...
  const address_v4& operator*() const EGT_ASIO_NOEXCEPT
  {
    return address_;
  }
...
#endif // EGT_ASIO_IP_ADDRESS_V4_ITERATOR_HPP
