...
#ifndef EGT_ASIO_IP_ADDRESS_V6_HPP
#define EGT_ASIO_IP_ADDRESS_V6_HPP
...
/**
 * The egt::asio::ip::address_v6 class provides the ability to use and
...
public:
...
#else
  typedef egt::asio::detail::array<unsigned char, 16> bytes_type;
#endif

  /// Default constructor.
  EGT_ASIO_DECL address_v6();

  /// Construct an address from raw bytes and scope ID.
  EGT_ASIO_DECL explicit address_v6(const bytes_type& bytes,
      unsigned long scope_id = 0);

  /// Copy constructor.
  EGT_ASIO_DECL address_v6(const address_v6& other);

#if defined(EGT_ASIO_HAS_MOVE)
  /// Move constructor.
  EGT_ASIO_DECL address_v6(address_v6&& other);
#endif // defined(EGT_ASIO_HAS_MOVE)

  /// Assign from another address.
  EGT_ASIO_DECL address_v6& operator=(const address_v6& other);

#if defined(EGT_ASIO_HAS_MOVE)
  /// Move-assign from another address.
  EGT_ASIO_DECL address_v6& operator=(address_v6&& other);
#endif // defined(EGT_ASIO_HAS_MOVE)
  ...
  EGT_ASIO_DECL address_v4 to_v4() const;
  ...
  EGT_ASIO_DECL bool is_link_local() const;

  /// Determine whether the address is site local.
  EGT_ASIO_DECL bool is_site_local() const;

  /// Determine whether the address is a mapped IPv4 address.
  EGT_ASIO_DECL bool is_v4_mapped() const;

#if !defined(EGT_ASIO_NO_DEPRECATED)
  /// (Deprecated: No replacement.) Determine whether the address is an
  /// IPv4-compatible address.
  EGT_ASIO_DECL bool is_v4_compatible() const;
#endif // !defined(EGT_ASIO_NO_DEPRECATED)
  ...
  EGT_ASIO_DECL bool is_multicast_global() const;

  /// Determine whether the address is a link-local multicast address.
  EGT_ASIO_DECL bool is_multicast_link_local() const;

  /// Determine whether the address is a node-local multicast address.
  EGT_ASIO_DECL bool is_multicast_node_local() const;

  /// Determine whether the address is a org-local multicast address.
  EGT_ASIO_DECL bool is_multicast_org_local() const;

  /// Determine whether the address is a site-local multicast address.
  EGT_ASIO_DECL bool is_multicast_site_local() const;
  ...
  EGT_ASIO_DECL static address_v6 loopback();

#if !defined(EGT_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use make_address_v6().) Create an IPv4-mapped IPv6 address.
  EGT_ASIO_DECL static address_v6 v4_mapped(const address_v4& addr);

  /// (Deprecated: No replacement.) Create an IPv4-compatible IPv6 address.
  EGT_ASIO_DECL static address_v6 v4_compatible(const address_v4& addr);
#endif // !defined(EGT_ASIO_NO_DEPRECATED)
...
private:
  ...
  egt::asio::detail::in6_addr_type addr_;
 ...
 * @relates address_v6
 */
EGT_ASIO_DECL address_v6 make_address_v6(const char* str);

/// Create an IPv6 address from an IP address string.
/**
 * @relates address_v6
 */
EGT_ASIO_DECL address_v6 make_address_v6(
    const char* str, egt::asio::error_code& ec);
 ...
 * @relates address_v6
 */
EGT_ASIO_DECL address_v6 make_address_v6(const std::string& str);
 ...
 * @relates address_v6
 */
EGT_ASIO_DECL address_v6 make_address_v6(string_view str);
