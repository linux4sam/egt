...
#ifndef EGT_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
#define EGT_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
...
private:
  egt::asio::detail::in4_mreq_type ipv4_value_;
  egt::asio::detail::in6_mreq_type ipv6_value_;
};
...
private:
  egt::asio::detail::in4_addr_type ipv4_value_;
...
#endif // EGT_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
