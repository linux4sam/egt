...
#ifndef EGT_ASIO_IP_BASIC_RESOLVER_ENTRY_HPP
#define EGT_ASIO_IP_BASIC_RESOLVER_ENTRY_HPP
...
/**
 * The egt::asio::ip::basic_resolver_entry class template describes an entry
...
#endif // EGT_ASIO_IP_BASIC_RESOLVER_ENTRY_HPP
