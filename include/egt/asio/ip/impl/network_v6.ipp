...
#ifndef EGT_ASIO_IP_IMPL_NETWORK_V6_IPP
#define EGT_ASIO_IP_IMPL_NETWORK_V6_IPP
...
EGT_ASIO_DECL address_v6 network_v6::network() const EGT_ASIO_NOEXCEPT
{
...
address_v6_range network_v6::hosts() const EGT_ASIO_NOEXCEPT
{
...
std::string network_v6::to_string(egt::asio::error_code& ec) const
{
...
network_v6 make_network_v6(const char* str, egt::asio::error_code& ec)
{
...
#endif // EGT_ASIO_IP_IMPL_NETWORK_V6_IPP
