...
#ifndef EGT_ASIO_IP_IMPL_ADDRESS_V4_HPP
#define EGT_ASIO_IP_IMPL_ADDRESS_V4_HPP
...
{
  return egt::asio::ip::make_address_v4(str);
}

inline address_v4 address_v4::from_string(
    const char* str, egt::asio::error_code& ec)
{
  return egt::asio::ip::make_address_v4(str, ec);
}
...
#endif // EGT_ASIO_IP_IMPL_ADDRESS_V4_HPP
