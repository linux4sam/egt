...
#ifndef EGT_ASIO_IP_IMPL_NETWORK_V4_IPP
#define EGT_ASIO_IP_IMPL_NETWORK_V4_IPP
...
address_v4 network_v4::netmask() const EGT_ASIO_NOEXCEPT
{
...
address_v4_range network_v4::hosts() const EGT_ASIO_NOEXCEPT
{
  return is_host()
...
std::string network_v4::to_string(egt::asio::error_code& ec) const
{
...
network_v4 make_network_v4(const char* str, egt::asio::error_code& ec)
{
...
#endif // EGT_ASIO_IP_IMPL_NETWORK_V4_IPP
