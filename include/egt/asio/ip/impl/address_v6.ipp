...
#ifndef EGT_ASIO_IP_IMPL_ADDRESS_V6_IPP
#define EGT_ASIO_IP_IMPL_ADDRESS_V6_IPP
...
std::string address_v6::to_string() const
{
  ...
  char addr_str[egt::asio::detail::max_addr_v6_str_len];
  const char* addr =
    egt::asio::detail::socket_ops::inet_ntop(
        EGT_ASIO_OS_DEF(AF_INET6), &addr_, addr_str,
        egt::asio::detail::max_addr_v6_str_len, scope_id_, ec);
  if (addr == 0)
...
std::string address_v6::to_string(egt::asio::error_code& ec) const
{
  char addr_str[egt::asio::detail::max_addr_v6_str_len];
  const char* addr =
    egt::asio::detail::socket_ops::inet_ntop(
...
bool operator==(const address_v6& a1, const address_v6& a2)
{
  ...
  return memcmp(&a1.addr_, &a2.addr_,
      sizeof(egt::asio::detail::in6_addr_type)) == 0
...
bool operator<(const address_v6& a1, const address_v6& a2)
{
  ...
  int memcmp_result = memcmp(&a1.addr_, &a2.addr_,
      sizeof(egt::asio::detail::in6_addr_type));
  if (memcmp_result < 0)
    return true;
  if (memcmp_result > 0)
    return false;
    ...
    const char* str, egt::asio::error_code& ec)
{
  ...
  if (egt::asio::detail::socket_ops::inet_pton(
        EGT_ASIO_OS_DEF(AF_INET6), str, &bytes[0], &scope_id, ec) <= 0)
    return address_v6();
...
#endif // EGT_ASIO_IP_IMPL_ADDRESS_V6_IPP
