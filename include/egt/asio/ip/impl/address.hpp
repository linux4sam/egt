...
#ifndef EGT_ASIO_IP_IMPL_ADDRESS_HPP
#define EGT_ASIO_IP_IMPL_ADDRESS_HPP
...
{
  return egt::asio::ip::make_address(str);
}

inline address address::from_string(
    const char* str, egt::asio::error_code& ec)
{
  return egt::asio::ip::make_address(str, ec);
}
...
#endif // EGT_ASIO_IP_IMPL_ADDRESS_HPP
