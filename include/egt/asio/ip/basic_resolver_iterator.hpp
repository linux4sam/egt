...
#ifndef EGT_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
#define EGT_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
...
/**
 * The egt::asio::ip::basic_resolver_iterator class template is used to define
...
public:
  ...
  basic_resolver_iterator(basic_resolver_iterator&& other)
    : values_(EGT_ASIO_MOVE_CAST(values_ptr_type)(other.values_)),
      index_(other.index_)
  {
    other.index_ = 0;
  }
...
protected:
  ...
  typedef egt::asio::detail::shared_ptr<values_type> values_ptr_type;
...
#endif // EGT_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
