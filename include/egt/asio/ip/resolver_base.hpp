...
#ifndef EGT_ASIO_IP_RESOLVER_BASE_HPP
#define EGT_ASIO_IP_RESOLVER_BASE_HPP
...
public:
  ...
  enum flags
  {
    canonical_name = EGT_ASIO_OS_DEF(AI_CANONNAME),
    passive = EGT_ASIO_OS_DEF(AI_PASSIVE),
    numeric_host = EGT_ASIO_OS_DEF(AI_NUMERICHOST),
    numeric_service = EGT_ASIO_OS_DEF(AI_NUMERICSERV),
    v4_mapped = EGT_ASIO_OS_DEF(AI_V4MAPPED),
    all_matching = EGT_ASIO_OS_DEF(AI_ALL),
    address_configured = EGT_ASIO_OS_DEF(AI_ADDRCONFIG)
  };
...
#endif // EGT_ASIO_IP_RESOLVER_BASE_HPP
