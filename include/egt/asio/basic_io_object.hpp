...
#ifndef EGT_ASIO_BASIC_IO_OBJECT_HPP
#define EGT_ASIO_BASIC_IO_OBJECT_HPP
...
public:
  ...
  typedef egt::asio::io_context::executor_type executor_type;
...
protected:
   ...
   */
  explicit basic_io_object(egt::asio::io_context& io_context)
    : service_(egt::asio::use_service<IoObjectService>(io_context))
  {
...
protected:
  ...
  basic_io_object(IoObjectService1& other_service,
      typename IoObjectService1::implementation_type& other_implementation)
    : service_(&egt::asio::use_service<IoObjectService>(
...
#endif // EGT_ASIO_BASIC_IO_OBJECT_HPP
