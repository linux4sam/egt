...
#ifndef EGT_ASIO_BUFFERED_STREAM_HPP
#define EGT_ASIO_BUFFERED_STREAM_HPP
...
public:
  ...
  {
    return stream_impl_.async_fill(EGT_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
...
#endif // EGT_ASIO_BUFFERED_STREAM_HPP
