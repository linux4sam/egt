...
#ifndef EGT_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
#define EGT_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
...
#else
  : public egt::asio::detail::service_base<datagram_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit datagram_socket_service(egt::asio::io_context& io_context)
  ...
  {
    if (protocol.type() == EGT_ASIO_OS_DEF(SOCK_DGRAM))
...
#endif // EGT_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
