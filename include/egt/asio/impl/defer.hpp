...
#ifndef EGT_ASIO_IMPL_DEFER_HPP
#define EGT_ASIO_IMPL_DEFER_HPP
...
EGT_ASIO_INITFN_RESULT_TYPE(CompletionToken, void()) defer(
    EGT_ASIO_MOVE_ARG(CompletionToken) token)
{
  ...
  ex.defer(EGT_ASIO_MOVE_CAST(handler)(init.completion_handler), alloc);
...
inline EGT_ASIO_INITFN_RESULT_TYPE(CompletionToken, void()) defer(
