...
#ifndef EGT_ASIO_IMPL_ERROR_IPP
#define EGT_ASIO_IMPL_ERROR_IPP
...
class netdb_category : public egt::asio::error_category
{
public:
...
class addrinfo_category : public egt::asio::error_category
{
public:
  const char* name() const EGT_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
...
class misc_category : public egt::asio::error_category
{
public:
  const char* name() const EGT_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
