...
#ifndef EGT_ASIO_IMPL_SERIAL_PORT_BASE_IPP
#define EGT_ASIO_IMPL_SERIAL_PORT_BASE_IPP
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::baud_rate::store(
    EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec) const
{
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::baud_rate::load(
    const EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec)
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::flow_control::store(
    EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec) const
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::flow_control::load(
    const EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec)
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::parity::store(
    EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec) const
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::parity::load(
    const EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec)
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::stop_bits::store(
    EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec) const
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::stop_bits::load(
    const EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec)
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::character_size::store(
    EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec) const
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
...
EGT_ASIO_SYNC_OP_VOID serial_port_base::character_size::load(
    const EGT_ASIO_OPTION_STORAGE& storage, egt::asio::error_code& ec)
{
#if defined(EGT_ASIO_WINDOWS) || defined(__CYGWIN__)
...
#endif // EGT_ASIO_IMPL_SERIAL_PORT_BASE_IPP
