...
#ifndef EGT_ASIO_IMPL_EXECUTION_CONTEXT_IPP
#define EGT_ASIO_IMPL_EXECUTION_CONTEXT_IPP
...
execution_context::execution_context()
  : service_registry_(new egt::asio::detail::service_registry(*this))
{
}
...
void execution_context::notify_fork(
    egt::asio::execution_context::fork_event event)
{
...
#endif // EGT_ASIO_IMPL_EXECUTION_CONTEXT_IPP
