...
#ifndef EGT_ASIO_IMPL_ERROR_CODE_IPP
#define EGT_ASIO_IMPL_ERROR_CODE_IPP
...
# include <string>
#endif
#include <egt/asio/detail/local_free_on_block_exit.hpp>
...
public:
  ...
  {
#if defined(EGT_ASIO_WINDOWS_RUNTIME) || defined(EGT_ASIO_WINDOWS_APP)
    ...
    if (length)
      ...
      return "asio.system error";
#else // defined(EGT_ASIO_WINDOWS_DESKTOP) || defined(__CYGWIN__)
#if !defined(__sun)
    if (value == ECANCELED)
...
#endif
#endif // defined(EGT_ASIO_WINDOWS_DESKTOP) || defined(__CYGWIN__)
  }

#if defined(EGT_ASIO_HAS_STD_ERROR_CODE)
  std::error_condition default_error_condition(
      int ev) const EGT_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
    switch (ev)
    {
    case access_denied:
...
#endif // defined(EGT_ASIO_HAS_STD_ERROR_CODE)
...
#endif // EGT_ASIO_IMPL_ERROR_CODE_IPP
