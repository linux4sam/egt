...
#ifndef EGT_ASIO_IMPL_WRITE_AT_HPP
#define EGT_ASIO_IMPL_WRITE_AT_HPP
    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  egt::asio::detail::throw_error(ec, "write_at");
...
template <typename SyncRandomAccessWriteDevice, typename Allocator,
    typename CompletionCondition>
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, egt::asio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, egt::asio::error_code& ec)
{
  std::size_t bytes_transferred = write_at(
      ...
      switch (start_ = start)
      {
        ...
        do
        {
          device_.async_write_some_at(
              ...
              EGT_ASIO_MOVE_CAST(write_at_op)(*this));
          return; default:
...
namespace detail
{
  ...
  public:
    write_at_streambuf_op(
        egt::asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  //private:
    egt::asio::basic_streambuf<Allocator>& streambuf_;
    WriteHandler handler_;
  };
  ...
  make_write_at_streambuf_op(
      egt::asio::basic_streambuf<Allocator>& b, WriteHandler handler)
  {
    ...
    Allocator1>
{
  ...
  static type get(
      ...
      const Allocator1& a = Allocator1()) EGT_ASIO_NOEXCEPT
  {
    ...
    Executor1>
{
  ...
  static type get(
      ...
      const Executor1& ex = Executor1()) EGT_ASIO_NOEXCEPT
  {
    ...
    EGT_ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  async_write_at(d, offset, b.data(), completion_condition,
    detail::write_at_streambuf_op<Allocator, EGT_ASIO_HANDLER_TYPE(
...
#endif // EGT_ASIO_IMPL_WRITE_AT_HPP
