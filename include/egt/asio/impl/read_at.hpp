...
#ifndef EGT_ASIO_IMPL_READ_AT_HPP
#define EGT_ASIO_IMPL_READ_AT_HPP
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  egt::asio::detail::throw_error(ec, "read_at");
      ...
      switch (start_ = start)
      {
        ...
        do
        {
          device_.async_read_some_at(
              ...
              EGT_ASIO_MOVE_CAST(read_at_op)(*this));
          return; default:
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          device_.async_read_some_at(offset_ + total_transferred_,
              ...
              EGT_ASIO_MOVE_CAST(read_at_streambuf_op)(*this));
          return; default:
    ...
    EGT_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_at_streambuf_op<AsyncRandomAccessReadDevice, Allocator,
    CompletionCondition, EGT_ASIO_HANDLER_TYPE(ReadHandler,
      void (egt::asio::error_code, std::size_t))>(
    ...
    EGT_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_at_streambuf_op<AsyncRandomAccessReadDevice, Allocator,
    detail::transfer_all_t, EGT_ASIO_HANDLER_TYPE(ReadHandler,
      void (egt::asio::error_code, std::size_t))>(
...
#endif // EGT_ASIO_IMPL_READ_AT_HPP
