...
#ifndef EGT_ASIO_IMPL_DISPATCH_HPP
#define EGT_ASIO_IMPL_DISPATCH_HPP
...
EGT_ASIO_INITFN_RESULT_TYPE(CompletionToken, void()) dispatch(
    EGT_ASIO_MOVE_ARG(CompletionToken) token)
{
  ...
  ex.dispatch(EGT_ASIO_MOVE_CAST(handler)(init.completion_handler), alloc);
...
inline EGT_ASIO_INITFN_RESULT_TYPE(CompletionToken, void()) dispatch(
...
#endif // EGT_ASIO_IMPL_DISPATCH_HPP
