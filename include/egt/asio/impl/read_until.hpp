...
#ifndef EGT_ASIO_IMPL_READ_UNTIL_HPP
#define EGT_ASIO_IMPL_READ_UNTIL_HPP
    ...
    EGT_ASIO_MOVE_ARG(DynamicBuffer) buffers, char delim)
{
  ...
  std::size_t bytes_transferred = read_until(s,
      EGT_ASIO_MOVE_CAST(DynamicBuffer)(buffers), delim, ec);
  egt::asio::detail::throw_error(ec, "read_until");
    ...
    const boost::regex& expr)
{
  egt::asio::error_code ec;
  std::size_t bytes_transferred = read_until(s,
      EGT_ASIO_MOVE_CAST(DynamicBuffer)(buffers), expr, ec);
  egt::asio::detail::throw_error(ec, "read_until");
  return bytes_transferred;
}
      ...
      case 1:
        for (;;)
        {
          ...
          stream_.async_read_some(buffers_.prepare(bytes_to_read),
              EGT_ASIO_MOVE_CAST(read_until_delim_op)(*this));
          return; default:
    ...
    char delim, EGT_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_until_delim_op<AsyncReadStream,
    typename decay<DynamicBuffer>::type,
      EGT_ASIO_HANDLER_TYPE(ReadHandler,
        void (egt::asio::error_code, std::size_t))>(
          s, EGT_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            delim, init.completion_handler)(egt::asio::error_code(), 0, 1);
...
namespace detail
{
  ...
  public:
    ...
    read_until_delim_string_op(read_until_delim_string_op&& other)
      : stream_(other.stream_),
        buffers_(EGT_ASIO_MOVE_CAST(DynamicBuffer)(other.buffers_)),
        delim_(EGT_ASIO_MOVE_CAST(std::string)(other.delim_)),
        start_(other.start_),
        search_position_(other.search_position_),
        handler_(EGT_ASIO_MOVE_CAST(ReadHandler)(other.handler_))
    {
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        for (;;)
        {
          ...
          // Start a new asynchronous read operation to obtain more data.
          stream_.async_read_some(buffers_.prepare(bytes_to_read),
              EGT_ASIO_MOVE_CAST(read_until_delim_string_op)(*this));
          return; default:
          buffers_.commit(bytes_transferred);
          if (ec || bytes_transferred == 0)
            break;
        ...
        void (egt::asio::error_code, std::size_t))>(
          s, EGT_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            static_cast<std::string>(delim),
              init.completion_handler)(egt::asio::error_code(), 0, 1);
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        for (;;)
        {
          ...
          // Start a new asynchronous read operation to obtain more data.
          stream_.async_read_some(buffers_.prepare(bytes_to_read),
              EGT_ASIO_MOVE_CAST(read_until_expr_op)(*this));
          return; default:
          buffers_.commit(bytes_transferred);
          if (ec || bytes_transferred == 0)
            break;
    ...
    EGT_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_until_expr_op<AsyncReadStream,
    typename decay<DynamicBuffer>::type,
      boost::regex, EGT_ASIO_HANDLER_TYPE(ReadHandler,
        void (egt::asio::error_code, std::size_t))>(
          s, EGT_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            expr, init.completion_handler)(egt::asio::error_code(), 0, 1);
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        for (;;)
        {
          ...
          // Start a new asynchronous read operation to obtain more data.
          stream_.async_read_some(buffers_.prepare(bytes_to_read),
              EGT_ASIO_MOVE_CAST(read_until_match_op)(*this));
          return; default:
          buffers_.commit(bytes_transferred);
          if (ec || bytes_transferred == 0)
            break;
    ...
    typename enable_if<is_match_condition<MatchCondition>::value>::type*)
{
  ...
  detail::read_until_match_op<AsyncReadStream,
    typename decay<DynamicBuffer>::type,
      MatchCondition, EGT_ASIO_HANDLER_TYPE(ReadHandler,
        void (egt::asio::error_code, std::size_t))>(
          s, EGT_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
    ...
    char delim, EGT_ASIO_MOVE_ARG(ReadHandler) handler)
{
  return async_read_until(s, basic_streambuf_ref<Allocator>(b),
      delim, EGT_ASIO_MOVE_CAST(ReadHandler)(handler));
}
...
{
  return async_read_until(s, basic_streambuf_ref<Allocator>(b),
      expr, EGT_ASIO_MOVE_CAST(ReadHandler)(handler));
}
...
{
  return async_read_until(s, basic_streambuf_ref<Allocator>(b),
      match_condition, EGT_ASIO_MOVE_CAST(ReadHandler)(handler));
}
...
#endif // EGT_ASIO_IMPL_READ_UNTIL_HPP
