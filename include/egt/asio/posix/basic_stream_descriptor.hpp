...
#ifndef EGT_ASIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
#define EGT_ASIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
...
public:
   ...
   * descriptor.
   */
  explicit basic_stream_descriptor(egt::asio::io_context& io_context)
   ...
   */
  basic_stream_descriptor(egt::asio::io_context& io_context,
  ...
  basic_stream_descriptor(basic_stream_descriptor&& other)
    : basic_descriptor<StreamDescriptorService>(
        EGT_ASIO_MOVE_CAST(basic_stream_descriptor)(other))
  {
  }
   ...
   * @code
   * descriptor.write_some(egt::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_write_some(egt::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      EGT_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    return this->get_service().async_write_some(this->get_implementation(),
        buffers, EGT_ASIO_MOVE_CAST(WriteHandler)(handler));
  }
   ...
   * @code
   * descriptor.read_some(egt::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_read_some(egt::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      EGT_ASIO_MOVE_ARG(ReadHandler) handler)
  {
    ...
    return this->get_service().async_read_some(this->get_implementation(),
        buffers, EGT_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
};
...
#endif // EGT_ASIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
