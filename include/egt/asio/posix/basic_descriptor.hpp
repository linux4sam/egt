...
#ifndef EGT_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
#define EGT_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(egt::asio::io_context& io_context)
   ...
   */
  basic_descriptor(egt::asio::io_context& io_context,
  ...
  basic_descriptor(basic_descriptor&& other)
    : basic_io_object<DescriptorService>(
        EGT_ASIO_MOVE_CAST(basic_descriptor)(other))
  {
  }
...
#endif // EGT_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
