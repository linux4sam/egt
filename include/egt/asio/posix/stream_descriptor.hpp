...
#ifndef EGT_ASIO_POSIX_STREAM_DESCRIPTOR_HPP
#define EGT_ASIO_POSIX_STREAM_DESCRIPTOR_HPP
...
public:
   ...
   */
  stream_descriptor(egt::asio::io_context& io_context,
...
#endif // EGT_ASIO_POSIX_STREAM_DESCRIPTOR_HPP
