...
#ifndef EGT_ASIO_POSIX_STREAM_DESCRIPTOR_SERVICE_HPP
#define EGT_ASIO_POSIX_STREAM_DESCRIPTOR_SERVICE_HPP
...
#else
  : public egt::asio::detail::service_base<stream_descriptor_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_descriptor_service(egt::asio::io_context& io_context)
    : egt::asio::detail::service_base<stream_descriptor_service>(io_context),
  ...
  EGT_ASIO_SYNC_OP_VOID wait(implementation_type& impl,
      descriptor_base::wait_type w, egt::asio::error_code& ec)
  {
...
#endif // EGT_ASIO_POSIX_STREAM_DESCRIPTOR_SERVICE_HPP
