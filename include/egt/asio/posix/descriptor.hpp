...
#ifndef EGT_ASIO_POSIX_DESCRIPTOR_HPP
#define EGT_ASIO_POSIX_DESCRIPTOR_HPP
...
#include <egt/asio/detail/reactive_descriptor_service.hpp>
...
#define EGT_ASIO_SVC_T egt::asio::detail::reactive_descriptor_service
...
public:
   ...
   * descriptor.
   */
  explicit descriptor(egt::asio::io_context& io_context)
   ...
   */
  descriptor(egt::asio::io_context& io_context,
   ...
   */
  EGT_ASIO_SYNC_OP_VOID assign(const native_handle_type& native_descriptor,
      egt::asio::error_code& ec)
  {
   ...
   * egt::asio::posix::descriptor_base::bytes_readable @n
   * egt::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * egt::asio::posix::stream_descriptor descriptor(io_context);
   * ...
   * egt::asio::posix::stream_descriptor::bytes_readable command;
   ...
   * egt::asio::posix::stream_descriptor descriptor(io_context);
   * ...
   * descriptor.wait(egt::asio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * egt::asio::error_code ec;
   * descriptor.wait(egt::asio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     egt::asio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   */
...
#endif // EGT_ASIO_POSIX_DESCRIPTOR_HPP
