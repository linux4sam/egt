...
#ifndef EGT_ASIO_SSL_IMPL_CONTEXT_IPP
#define EGT_ASIO_SSL_IMPL_CONTEXT_IPP
...
#include <egt/asio/ssl/context.hpp>
  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    egt::asio::detail::throw_error(
        egt::asio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    ...
    egt::asio::detail::throw_error(ec, "context");
  }
...
{
  context tmp(EGT_ASIO_MOVE_CAST(context)(*this));
  handle_ = other.handle_;
  other.handle_ = 0;
  return *this;
}
...
void context::clear_options(context::options o)
{
  egt::asio::error_code ec;
  clear_options(o, ec);
  egt::asio::detail::throw_error(ec, "clear_options");
}

EGT_ASIO_SYNC_OP_VOID context::clear_options(
    context::options o, egt::asio::error_code& ec)
{
...
void context::set_options(context::options o)
{
  egt::asio::error_code ec;
  set_options(o, ec);
  egt::asio::detail::throw_error(ec, "set_options");
}

EGT_ASIO_SYNC_OP_VOID context::set_options(
    context::options o, egt::asio::error_code& ec)
{
#if !defined(SSL_OP_NO_COMPRESSION)
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      egt::asio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  egt::asio::detail::throw_error(ec, "set_verify_mode");
}

EGT_ASIO_SYNC_OP_VOID context::set_verify_mode(
...
void context::set_verify_depth(int depth)
{
  ...
  egt::asio::detail::throw_error(ec, "set_verify_depth");
}

EGT_ASIO_SYNC_OP_VOID context::set_verify_depth(
...
void context::load_verify_file(const std::string& filename)
{
  ...
  egt::asio::detail::throw_error(ec, "load_verify_file");
}

EGT_ASIO_SYNC_OP_VOID context::load_verify_file(
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  egt::asio::detail::throw_error(ec, "add_certificate_authority");
}

EGT_ASIO_SYNC_OP_VOID context::add_certificate_authority(
...
void context::set_default_verify_paths()
{
  ...
  egt::asio::detail::throw_error(ec, "set_default_verify_paths");
}

EGT_ASIO_SYNC_OP_VOID context::set_default_verify_paths(
    egt::asio::error_code& ec)
{
  ::ERR_clear_error();
...
void context::add_verify_path(const std::string& path)
{
  ...
  egt::asio::detail::throw_error(ec, "add_verify_path");
}

EGT_ASIO_SYNC_OP_VOID context::add_verify_path(
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  egt::asio::detail::throw_error(ec, "use_certificate");
}

EGT_ASIO_SYNC_OP_VOID context::use_certificate(
    const const_buffer& certificate, file_format format,
    egt::asio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, file_format format)
{
  ...
  egt::asio::detail::throw_error(ec, "use_certificate_file");
}

EGT_ASIO_SYNC_OP_VOID context::use_certificate_file(
    const std::string& filename, file_format format,
    egt::asio::error_code& ec)
{
  int file_type;
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  egt::asio::detail::throw_error(ec, "use_certificate_chain");
}

EGT_ASIO_SYNC_OP_VOID context::use_certificate_chain(
    const const_buffer& chain, egt::asio::error_code& ec)
{
  ...
  if (bio.p)
  {
    ...
    if (!cert.p)
    {
      ec = egt::asio::error_code(ERR_R_PEM_LIB,
          egt::asio::error::get_ssl_category());
      EGT_ASIO_SYNC_OP_VOID_RETURN(ec);
    }
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  egt::asio::detail::throw_error(ec, "use_certificate_chain_file");
}

EGT_ASIO_SYNC_OP_VOID context::use_certificate_chain_file(
    const std::string& filename, egt::asio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  egt::asio::detail::throw_error(ec, "use_private_key");
}

EGT_ASIO_SYNC_OP_VOID context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    egt::asio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, context::file_format format)
{
  ...
  egt::asio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  egt::asio::detail::throw_error(ec, "use_rsa_private_key");
}

EGT_ASIO_SYNC_OP_VOID context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    egt::asio::error_code& ec)
{
  ::ERR_clear_error();
...
EGT_ASIO_SYNC_OP_VOID context::use_private_key_file(
    const std::string& filename, context::file_format format,
    egt::asio::error_code& ec)
{
  int file_type;
    ...
    const std::string& filename, context::file_format format)
{
  ...
  egt::asio::detail::throw_error(ec, "use_rsa_private_key_file");
}

EGT_ASIO_SYNC_OP_VOID context::use_rsa_private_key_file(
    const std::string& filename, context::file_format format,
    egt::asio::error_code& ec)
{
  int file_type;
...
void context::use_tmp_dh(const const_buffer& dh)
{
  egt::asio::error_code ec;
  use_tmp_dh(dh, ec);
  egt::asio::detail::throw_error(ec, "use_tmp_dh");
}

EGT_ASIO_SYNC_OP_VOID context::use_tmp_dh(
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  egt::asio::detail::throw_error(ec, "use_tmp_dh_file");
}

EGT_ASIO_SYNC_OP_VOID context::use_tmp_dh_file(
    const std::string& filename, egt::asio::error_code& ec)
{
  ::ERR_clear_error();
...
EGT_ASIO_SYNC_OP_VOID context::do_use_tmp_dh(
...
EGT_ASIO_SYNC_OP_VOID context::do_set_verify_callback(
...
EGT_ASIO_SYNC_OP_VOID context::do_set_password_callback(
...
#endif // EGT_ASIO_SSL_IMPL_CONTEXT_IPP
