...
#ifndef EGT_ASIO_SSL_CONTEXT_HPP
#define EGT_ASIO_SSL_CONTEXT_HPP
...
#include <egt/asio/ssl/detail/password_callback.hpp>
...
public:
  ...
  /// Constructor.
  EGT_ASIO_DECL explicit context(method m);
   ...
   */
  EGT_ASIO_DECL context(context&& other);
   ...
   * @li As a target for move-assignment.
   */
  EGT_ASIO_DECL context& operator=(context&& other);
#endif // defined(EGT_ASIO_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)

  /// Destructor.
  EGT_ASIO_DECL ~context();
   ...
   */
  EGT_ASIO_DECL native_handle_type native_handle();
   ...
   */
  EGT_ASIO_DECL void clear_options(options o);
   ...
   * @note Calls @c SSL_CTX_clear_options.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID clear_options(options o,
   ...
   */
  EGT_ASIO_DECL void set_options(options o);
   ...
   * @note Calls @c SSL_CTX_set_options.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID set_options(options o,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void set_verify_mode(verify_mode v);
   ...
   * @note Calls @c SSL_CTX_set_verify.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID set_verify_mode(
   ...
   */
  EGT_ASIO_DECL void set_verify_depth(int depth);
   ...
   * @note Calls @c SSL_CTX_set_verify_depth.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID set_verify_depth(
   ...
   */
  template <typename VerifyCallback>
  EGT_ASIO_SYNC_OP_VOID set_verify_callback(VerifyCallback callback,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void load_verify_file(const std::string& filename);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID load_verify_file(
      const std::string& filename, egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void add_certificate_authority(const const_buffer& ca);
   ...
   * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID add_certificate_authority(
      const const_buffer& ca, egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void set_default_verify_paths();
   ...
   * @note Calls @c SSL_CTX_set_default_verify_paths.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID set_default_verify_paths(
      egt::asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  EGT_ASIO_DECL void add_verify_path(const std::string& path);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID add_verify_path(
      const std::string& path, egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_certificate(
   ...
   * @note Calls @c SSL_CTX_use_certificate or SSL_CTX_use_certificate_ASN1.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_certificate(
      const const_buffer& certificate, file_format format,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_certificate_file(
   ...
   * @note Calls @c SSL_CTX_use_certificate_file.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_certificate_file(
      const std::string& filename, file_format format,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_certificate_chain(const const_buffer& chain);
   ...
   * @note Calls @c SSL_CTX_use_certificate and SSL_CTX_add_extra_chain_cert.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_certificate_chain(
      const const_buffer& chain, egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_certificate_chain_file(const std::string& filename);
   ...
   * @note Calls @c SSL_CTX_use_certificate_chain_file.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_certificate_chain_file(
      const std::string& filename, egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_private_key(
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey or SSL_CTX_use_PrivateKey_ASN1.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_private_key(
      const const_buffer& private_key, file_format format,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_private_key_file(
      const std::string& filename, file_format format);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey_file.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_private_key_file(
      const std::string& filename, file_format format,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_rsa_private_key(
      const const_buffer& private_key, file_format format);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey or SSL_CTX_use_RSAPrivateKey_ASN1.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_rsa_private_key(
      const const_buffer& private_key, file_format format,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_rsa_private_key_file(
      const std::string& filename, file_format format);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey_file.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_rsa_private_key_file(
      const std::string& filename, file_format format,
      egt::asio::error_code& ec);
   ...
   */
  EGT_ASIO_DECL void use_tmp_dh(const const_buffer& dh);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_tmp_dh(
      const const_buffer& dh, egt::asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  EGT_ASIO_DECL void use_tmp_dh_file(const std::string& filename);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID use_tmp_dh_file(
      const std::string& filename, egt::asio::error_code& ec);
   ...
   */
  template <typename PasswordCallback>
  EGT_ASIO_SYNC_OP_VOID set_password_callback(PasswordCallback callback,
      egt::asio::error_code& ec);
...
private:
  ...
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID do_set_verify_callback(
      detail::verify_callback_base* callback, egt::asio::error_code& ec);
  ...
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID do_set_password_callback(
      detail::password_callback_base* callback, egt::asio::error_code& ec);

  // Callback used when the SSL implementation wants a password.
  EGT_ASIO_DECL static int password_callback_function(
      char* buf, int size, int purpose, void* data);

  // Helper function to set the temporary Diffie-Hellman parameters from a BIO.
  EGT_ASIO_DECL EGT_ASIO_SYNC_OP_VOID do_use_tmp_dh(
      BIO* bio, egt::asio::error_code& ec);

  // Helper function to make a BIO from a memory buffer.
  EGT_ASIO_DECL BIO* make_buffer_bio(const const_buffer& b);

  // The underlying native implementation.
  native_handle_type handle_;

  // Ensure openssl is initialised.
  egt::asio::ssl::detail::openssl_init<> init_;
};
