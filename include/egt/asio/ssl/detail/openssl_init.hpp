...
#ifndef EGT_ASIO_SSL_DETAIL_OPENSSL_INIT_HPP
#define EGT_ASIO_SSL_DETAIL_OPENSSL_INIT_HPP
...
protected:
  ...
  EGT_ASIO_DECL static egt::asio::detail::shared_ptr<do_init> instance();

#if !defined(SSL_OP_NO_COMPRESSION) \
  && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
  // Get an empty stack of compression methods, to be used when disabling
  // compression.
  EGT_ASIO_DECL static STACK_OF(SSL_COMP)* get_null_compression_methods();
...
private:
  ...
  egt::asio::detail::shared_ptr<do_init> ref_;
};
...
#endif // EGT_ASIO_SSL_DETAIL_OPENSSL_INIT_HPP
