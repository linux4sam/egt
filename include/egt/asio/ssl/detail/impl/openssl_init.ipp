...
#ifndef EGT_ASIO_SSL_DETAIL_IMPL_OPENSSL_INIT_IPP
#define EGT_ASIO_SSL_DETAIL_IMPL_OPENSSL_INIT_IPP
...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new egt::asio::detail::mutex);
...
private:
  ...
  static unsigned long openssl_id_func()
  {
    ...
    void* id = &errno;
    EGT_ASIO_ASSERT(sizeof(unsigned long) >= sizeof(void*));
  ...
  std::vector<egt::asio::detail::shared_ptr<
        egt::asio::detail::mutex> > mutexes_;
#endif // (OPENSSL_VERSION_NUMBER < 0x10100000L)
...
egt::asio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static egt::asio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}
...
#endif // EGT_ASIO_SSL_DETAIL_IMPL_OPENSSL_INIT_IPP
