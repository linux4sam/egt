...
#ifndef EGT_ASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
#define EGT_ASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
...
public:
  buffered_handshake_op(stream_base::handshake_type type,
    ...
    : type_(type),
      buffers_(buffers),
      total_buffer_size_(egt::asio::buffer_size(buffers_))
  {
  }
      ...
      std::size_t& bytes_transferred) const
  {
    return this->process(eng, ec, bytes_transferred,
        egt::asio::buffer_sequence_begin(buffers_),
        egt::asio::buffer_sequence_end(buffers_));
  }
...
#endif // EGT_ASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
