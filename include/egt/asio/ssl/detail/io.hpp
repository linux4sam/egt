...
#ifndef EGT_ASIO_SSL_DETAIL_IO_HPP
#define EGT_ASIO_SSL_DETAIL_IO_HPP
...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, egt::asio::error_code& ec)
{
  ...
  case engine::want_input_and_retry:
    ...
    if (core.input_.size() == 0)
      core.input_ = egt::asio::buffer(core.input_buffer_,
...
public:
  ...
  io_op(io_op&& other)
    : next_layer_(other.next_layer_),
      core_(other.core_),
      op_(EGT_ASIO_MOVE_CAST(Operation)(other.op_)),
      start_(other.start_),
      want_(other.want_),
      ec_(other.ec_),
      bytes_transferred_(other.bytes_transferred_),
      ...
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (core_.expiry(core_.pending_read_) == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                egt::asio::buffer(core_.input_buffer_),
                EGT_ASIO_MOVE_CAST(io_op)(*this));
          }
          else
          {
            // Wait until the current read operation completes.
            core_.pending_read_.async_wait(EGT_ASIO_MOVE_CAST(io_op)(*this));
          }
        ...
        case engine::want_output:
          ...
          if (core_.expiry(core_.pending_write_) == core_.neg_infin())
          {
            ...
            egt::asio::async_write(next_layer_,
          ...
          else
          {
            ...
            core_.pending_write_.async_wait(EGT_ASIO_MOVE_CAST(io_op)(*this));
          }
        ...
        default:
          ...
          {
            next_layer_.async_read_some(
                egt::asio::buffer(core_.input_buffer_, 0),
                EGT_ASIO_MOVE_CAST(io_op)(*this));
    ...
    io_op<Stream, Operation, Handler>* this_handler)
{
  return this_handler->start_ == 0 ? true
    : egt_asio_handler_cont_helpers::is_continuation(this_handler->handler_);
}
...
#endif // EGT_ASIO_SSL_DETAIL_IO_HPP
