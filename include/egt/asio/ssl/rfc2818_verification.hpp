...
#ifndef EGT_ASIO_SSL_RFC2818_VERIFICATION_HPP
#define EGT_ASIO_SSL_RFC2818_VERIFICATION_HPP
 ...
 * egt::asio::connect(sock.lowest_layer(), resolver.resolve(query));
...
public:
  ...
  EGT_ASIO_DECL bool operator()(bool preverified, verify_context& ctx) const;

private:
  // Helper function to check a host name against a pattern.
  EGT_ASIO_DECL static bool match_pattern(const char* pattern,
...
#endif // EGT_ASIO_SSL_RFC2818_VERIFICATION_HPP
