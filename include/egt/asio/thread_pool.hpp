...
#ifndef EGT_ASIO_THREAD_POOL_HPP
#define EGT_ASIO_THREAD_POOL_HPP
 ...
 * egt::asio::thread_pool pool(4);
 *
 * // Submit a function to the pool.
 * egt::asio::post(pool, my_task);
 *
...
public:
  ...
  EGT_ASIO_DECL thread_pool();

  /// Constructs a pool with a specified number of threads.
  EGT_ASIO_DECL thread_pool(std::size_t num_threads);
...
public:
  ...
  thread_pool& context() const EGT_ASIO_NOEXCEPT;
