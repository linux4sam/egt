...
#ifndef EGT_ASIO_BASIC_DEADLINE_TIMER_HPP
#define EGT_ASIO_BASIC_DEADLINE_TIMER_HPP
...
# define EGT_ASIO_SVC_T detail::deadline_timer_service<TimeTraits>
 ...
 *
 * Most applications will use the egt::asio::deadline_timer typedef.
 *
 * @par Thread Safety
 ...
 * egt::asio::deadline_timer timer(io_context);
 *
 ...
 * @endcode
 *
 * @li The egt::asio::basic_deadline_timer::expires_from_now() function
...
template <typename Time,
    typename TimeTraits = egt::asio::time_traits<Time>
    EGT_ASIO_SVC_TPARAM_DEF2(= deadline_timer_service<Time, TimeTraits>)>
...
public:
   ...
   */
  explicit basic_deadline_timer(egt::asio::io_context& io_context)
   ...
   * as an absolute time.
   */
  basic_deadline_timer(egt::asio::io_context& io_context,
...
#endif // EGT_ASIO_BASIC_DEADLINE_TIMER_HPP
