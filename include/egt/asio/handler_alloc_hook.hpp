...
#ifndef EGT_ASIO_HANDLER_ALLOC_HOOK_HPP
#define EGT_ASIO_HANDLER_ALLOC_HOOK_HPP
 ...
 * @endcode
 */
EGT_ASIO_DECL void* asio_handler_allocate(
    std::size_t size, ...);
 ...
 */
EGT_ASIO_DECL void asio_handler_deallocate(
...
#endif // EGT_ASIO_HANDLER_ALLOC_HOOK_HPP
