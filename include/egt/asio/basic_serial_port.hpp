...
#ifndef EGT_ASIO_BASIC_SERIAL_PORT_HPP
#define EGT_ASIO_BASIC_SERIAL_PORT_HPP
...
public:
   ...
   */
  explicit basic_serial_port(egt::asio::io_context& io_context)
   ...
   */
  basic_serial_port(egt::asio::io_context& io_context,
  ...
  basic_serial_port(basic_serial_port&& other)
    : basic_io_object<SerialPortService>(
        EGT_ASIO_MOVE_CAST(basic_serial_port)(other))
  {
  }
...
#endif // EGT_ASIO_BASIC_SERIAL_PORT_HPP
