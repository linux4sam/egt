...
#ifndef EGT_ASIO_EXECUTOR_WORK_GUARD_HPP
#define EGT_ASIO_EXECUTOR_WORK_GUARD_HPP
...
public:
   ...
   */
  explicit executor_work_guard(const executor_type& e) EGT_ASIO_NOEXCEPT
    : executor_(e),
      owns_(true)
  {
  ...
  /// Copy constructor.
  executor_work_guard(const executor_work_guard& other) EGT_ASIO_NOEXCEPT
  ...
  bool owns_work() const EGT_ASIO_NOEXCEPT
  {
    return owns_;
  }
...
#endif // EGT_ASIO_EXECUTOR_WORK_GUARD_HPP
