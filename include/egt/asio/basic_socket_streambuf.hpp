...
#ifndef EGT_ASIO_BASIC_SOCKET_STREAMBUF_HPP
#define EGT_ASIO_BASIC_SOCKET_STREAMBUF_HPP
...
# include <egt/asio/stream_socket_service.hpp>
  ...
  && defined(EGT_ASIO_USE_BOOST_DATE_TIME_FOR_SOCKET_IOSTREAM)
# if defined(EGT_ASIO_ENABLE_OLD_SERVICES)
#  include <egt/asio/deadline_timer_service.hpp>
# else // defined(EGT_ASIO_ENABLE_OLD_SERVICES)
#  include <egt/asio/detail/deadline_timer_service.hpp>
# endif // defined(EGT_ASIO_ENABLE_OLD_SERVICES)
#else // defined(EGT_ASIO_HAS_BOOST_DATE_TIME)
      // && defined(EGT_ASIO_USE_BOOST_DATE_TIME_FOR_SOCKET_IOSTREAM)
...
# define EGT_ASIO_PRIVATE_CONNECT_DEF(n) \
  template <EGT_ASIO_VARIADIC_TPARAMS(n)> \
  basic_socket_streambuf* connect(EGT_ASIO_VARIADIC_BYVAL_PARAMS(n)) \
  { \
    init_buffers(); \
    typedef typename Protocol::resolver resolver_type; \
    resolver_type resolver(socket().get_executor().context()); \
    connect_to_endpoints( \
        resolver.resolve(EGT_ASIO_VARIADIC_BYVAL_ARGS(n), ec_)); \
    return !ec_ ? this : 0; \
  } \
  /**/
...
#if !defined(EGT_ASIO_ENABLE_OLD_SERVICES)
# define EGT_ASIO_SVC_T1 detail::deadline_timer_service<traits_helper>
#endif // !defined(EGT_ASIO_ENABLE_OLD_SERVICES)
...
#if !defined(EGT_ASIO_BASIC_SOCKET_STREAMBUF_FWD_DECL)
#define EGT_ASIO_BASIC_SOCKET_STREAMBUF_FWD_DECL

// Forward declaration with defaulted arguments.
template <typename Protocol
    EGT_ASIO_SVC_TPARAM_DEF1(= stream_socket_service<Protocol>),
#if defined(EGT_ASIO_HAS_BOOST_DATE_TIME) \
  && defined(EGT_ASIO_USE_BOOST_DATE_TIME_FOR_SOCKET_IOSTREAM)
    typename Clock = boost::posix_time::ptime,
    typename WaitTraits = time_traits<Clock>
    EGT_ASIO_SVC_TPARAM1_DEF2(= deadline_timer_service<Clock, WaitTraits>)>
#else // defined(EGT_ASIO_HAS_BOOST_DATE_TIME)
      // && defined(EGT_ASIO_USE_BOOST_DATE_TIME_FOR_SOCKET_IOSTREAM)
    typename Clock = chrono::steady_clock,
    typename WaitTraits = wait_traits<Clock>
    EGT_ASIO_SVC_TPARAM1_DEF1(= steady_timer::service_type)>
#endif // defined(EGT_ASIO_HAS_BOOST_DATE_TIME)
       // && defined(EGT_ASIO_USE_BOOST_DATE_TIME_FOR_SOCKET_IOSTREAM)
class basic_socket_streambuf;

#endif // !defined(EGT_ASIO_BASIC_SOCKET_STREAMBUF_FWD_DECL)
...
template <typename Protocol EGT_ASIO_SVC_TPARAM,
    typename Clock, typename WaitTraits EGT_ASIO_SVC_TPARAM1>
...
class basic_socket_streambuf
  : public std::streambuf,
    ...
    private basic_socket<Protocol EGT_ASIO_SVC_TARG>
...
# endif // !defined(EGT_ASIO_NO_DEPRECATED)
  ...
  basic_socket_streambuf()
    : detail::socket_streambuf_io_context(new io_context),
      basic_socket<Protocol EGT_ASIO_SVC_TARG>(*default_io_context_),
  ...
  explicit basic_socket_streambuf(basic_stream_socket<protocol_type> s)
    : detail::socket_streambuf_io_context(0),
      basic_socket<Protocol EGT_ASIO_SVC_TARG>(std::move(s)),
      expiry_time_(max_expiry_time())
  {
    init_buffers();
  }
  ...
  basic_socket_streambuf(basic_socket_streambuf&& other)
    : detail::socket_streambuf_io_context(other),
      basic_socket<Protocol EGT_ASIO_SVC_TARG>(std::move(other.socket())),
      ec_(other.ec_),
...
#elif defined(EGT_ASIO_HAS_VARIADIC_TEMPLATES)
  template <typename... T>
...
#else
  EGT_ASIO_VARIADIC_GENERATE(EGT_ASIO_PRIVATE_CONNECT_DEF)
#endif
  ...
  basic_socket<Protocol EGT_ASIO_SVC_TARG>& socket()
  {
    return *this;
  }
   ...
   * buffer.
   */
  const egt::asio::error_code& error() const
  {
    return ec_;
  }
   ...
   * buffer.
   */
  const egt::asio::error_code& puberror() const
  {
    return error();
  }
   ...
   * egt::asio::error::operation_aborted.
   *
...
protected:
  int_type underflow()
  {
    ...
    ec_ = egt::asio::error::operation_not_supported;
    ...
    for (;;)
    {
      ...
      detail::buffer_sequence_adapter<mutable_buffer, mutable_buffer>
        bufs(egt::asio::buffer(get_buffer_) + putback_max);
      ...
      if (bytes == 0)
      {
        ec_ = egt::asio::error::eof;
        return traits_type::eof();
      }

      // Operation failed.
      if (ec_ != egt::asio::error::would_block
          && ec_ != egt::asio::error::try_again)
        return traits_type::eof();
  ...
  int_type overflow(int_type c)
  {
    ...
    if (put_buffer_.empty())
    {
      ...
      output_buffer = egt::asio::buffer(&ch, sizeof(char_type));
    }
    else
    {
      output_buffer = egt::asio::buffer(pbase(),
...
private:
  ...
  basic_socket_streambuf(const basic_socket_streambuf&) EGT_ASIO_DELETED;
  basic_socket_streambuf& operator=(
      const basic_socket_streambuf&) EGT_ASIO_DELETED;
  ...
  void connect_to_endpoints(EndpointIterator begin, EndpointIterator end)
  {
    ...
    for (EndpointIterator i = begin; i != end; ++i)
    {
      ...
      // Operation failed.
      if (ec_ != egt::asio::error::in_progress
          && ec_ != egt::asio::error::would_block)
        continue;
      ...
      ec_ = egt::asio::error_code(connect_error,
...
#if !defined(EGT_ASIO_ENABLE_OLD_SERVICES)
# undef EGT_ASIO_SVC_T1
#endif // !defined(EGT_ASIO_ENABLE_OLD_SERVICES)

#if !defined(EGT_ASIO_HAS_VARIADIC_TEMPLATES)
# undef EGT_ASIO_PRIVATE_CONNECT_DEF
#endif // !defined(EGT_ASIO_HAS_VARIADIC_TEMPLATES)

#endif // !defined(EGT_ASIO_NO_IOSTREAM)

#endif // EGT_ASIO_BASIC_SOCKET_STREAMBUF_HPP
