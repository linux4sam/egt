...
#ifndef EGT_ASIO_SYSTEM_ERROR_HPP
#define EGT_ASIO_SYSTEM_ERROR_HPP
...
#else // defined(EGT_ASIO_HAS_STD_SYSTEM_ERROR)
# include <cerrno>
# include <exception>
# include <string>
...
private:
  ...
  mutable egt::asio::detail::scoped_ptr<std::string> what_;
};
...
#endif // EGT_ASIO_SYSTEM_ERROR_HPP
