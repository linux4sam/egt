...
#ifndef EGT_ASIO_IO_CONTEXT_HPP
#define EGT_ASIO_IO_CONTEXT_HPP
...
# include <egt/asio/detail/winsock_init.hpp>
  ...
  || defined(__osf__)
# include <egt/asio/detail/signal_init.hpp>
#endif
 ...
 *
 * @li egt::asio::ip::tcp::socket
 * @li egt::asio::ip::tcp::acceptor
 * @li egt::asio::ip::udp::socket
 * @li egt::asio::deadline_timer.
 *
 ...
 *
 * To submit functions to the io_context, use the @ref egt::asio::dispatch,
 * @ref egt::asio::post or @ref egt::asio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * egt::asio::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * egt::asio::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * egt::asio::executor_work_guard<io_context::executor_type>:
 *
 * @code egt::asio::io_context io_context;
 * egt::asio::executor_work_guard<egt::asio::io_context::executor_type>
 *   = egt::asio::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
   ...
   */
  EGT_ASIO_DECL explicit io_context(int concurrency_hint);
   ...
   * without blocking.
   */
  EGT_ASIO_DECL count_type run(egt::asio::error_code& ec);
#endif // !defined(EGT_ASIO_NO_DEPRECATED)

#if defined(EGT_ASIO_HAS_CHRONO) || defined(GENERATING_DOCUMENTATION)
...
#endif // defined(EGT_ASIO_HAS_CHRONO) || defined(GENERATING_DOCUMENTATION)
   ...
   */
  EGT_ASIO_DECL count_type run_one();
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  EGT_ASIO_DECL count_type run_one(egt::asio::error_code& ec);
#endif // !defined(EGT_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  EGT_ASIO_DECL count_type poll(egt::asio::error_code& ec);
#endif // !defined(EGT_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  EGT_ASIO_DECL count_type poll_one();
   ...
   * @return The number of handlers that were executed.
   */
  EGT_ASIO_DECL count_type poll_one(egt::asio::error_code& ec);
#endif // !defined(EGT_ASIO_NO_DEPRECATED)
   ...
   */
  EGT_ASIO_DECL bool stopped() const;
  ...
  /// (Deprecated: Use egt::asio::dispatch().) Request the io_context to
  ...
  dispatch(EGT_ASIO_MOVE_ARG(LegacyCompletionHandler) handler);

  /// (Deprecated: Use egt::asio::post().) Request the io_context to invoke
  ...
  template <typename LegacyCompletionHandler>
  EGT_ASIO_INITFN_RESULT_TYPE(LegacyCompletionHandler, void ())
  post(EGT_ASIO_MOVE_ARG(LegacyCompletionHandler) handler);

  /// (Deprecated: Use egt::asio::bind_executor().) Create a new handler that
...
private:
  ...
  EGT_ASIO_DECL impl_type& add_impl(impl_type* impl);
...
public:
  ...
  io_context& context() const EGT_ASIO_NOEXCEPT;
  ...
  void dispatch(EGT_ASIO_MOVE_ARG(Function) f, const Allocator& a) const;
   ...
   */
  template <typename Function, typename Allocator>
  void post(EGT_ASIO_MOVE_ARG(Function) f, const Allocator& a) const;
   ...
   */
  template <typename Function, typename Allocator>
  void defer(EGT_ASIO_MOVE_ARG(Function) f, const Allocator& a) const;
   ...
   * returns @c false.
   */
  bool running_in_this_thread() const EGT_ASIO_NOEXCEPT;
  ...
  friend bool operator==(const executor_type& a,
      const executor_type& b) EGT_ASIO_NOEXCEPT
  {
...
public:
   ...
   */
  explicit work(egt::asio::io_context& io_context);
...
private:
  ...
  EGT_ASIO_DECL virtual void shutdown();

#if !defined(EGT_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use shutdown().) Destroy all user-defined handler objects
  /// owned by the service.
  EGT_ASIO_DECL virtual void shutdown_service();
#endif // !defined(EGT_ASIO_NO_DEPRECATED)
   ...
   */
  EGT_ASIO_DECL virtual void notify_fork(
   ...
   * implement it if necessary. The default implementation does nothing.
   */
  EGT_ASIO_DECL virtual void fork_service(
      execution_context::fork_event event);
#endif // !defined(EGT_ASIO_NO_DEPRECATED)
...
protected:
   ...
   */
  EGT_ASIO_DECL service(egt::asio::io_context& owner);

  /// Destructor.
  EGT_ASIO_DECL virtual ~service();
};
...
{
public:
  static egt::asio::detail::service_id<Type> id;

  // Constructor.
  service_base(egt::asio::io_context& io_context)
    : egt::asio::io_context::service(io_context)
  {
  }
};

template <typename Type>
egt::asio::detail::service_id<Type> service_base<Type>::id;
...
#include <egt/asio/impl/io_context.hpp>
...
#if !defined(EGT_ASIO_NO_EXTENSIONS)
# if defined(EGT_ASIO_STRAND_HPP)
#  include <egt/asio/io_context_strand.hpp>
# endif // defined(EGT_ASIO_STRAND_HPP)
#endif // !defined(EGT_ASIO_NO_EXTENSIONS)

#endif // EGT_ASIO_IO_CONTEXT_HPP
