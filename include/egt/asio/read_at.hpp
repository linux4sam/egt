...
#ifndef EGT_ASIO_READ_AT_HPP
#define EGT_ASIO_READ_AT_HPP
...
/**
 * @defgroup read_at egt::asio::read_at
 *
 ...
 * @code egt::asio::read_at(d, 42, egt::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code egt::asio::read_at(
 *     d, 42, buffers,
 *     egt::asio::transfer_all()); @endcode
 */
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::read_at(d, 42,
 *     egt::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @code egt::asio::read_at(
 *     d, 42, buffers,
 *     egt::asio::transfer_all(), ec); @endcode
 */
template <typename SyncRandomAccessReadDevice, typename MutableBufferSequence>
std::size_t read_at(SyncRandomAccessReadDevice& d,
    uint64_t offset, const MutableBufferSequence& buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::read_at(d, 42, egt::asio::buffer(data, size),
 *     egt::asio::transfer_at_least(32)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 */
...
/*@}*/
/**
 * @defgroup async_read_at egt::asio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * egt::asio::async_read_at(d, 42, egt::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code egt::asio::async_read_at(
 *     d, 42, buffers,
 *     egt::asio::transfer_all(),
 *     handler); @endcode
 */
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::async_read_at(d, 42,
 *     egt::asio::buffer(data, size),
 *     egt::asio::transfer_at_least(32),
 *     handler); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
EGT_ASIO_INITFN_RESULT_TYPE(ReadHandler,
    void (egt::asio::error_code, std::size_t))
async_read_at(AsyncRandomAccessReadDevice& d, uint64_t offset,
    basic_streambuf<Allocator>& b, EGT_ASIO_MOVE_ARG(ReadHandler) handler);
...
#include <egt/asio/impl/read_at.hpp>

#endif // EGT_ASIO_READ_AT_HPP
