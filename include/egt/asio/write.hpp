...
#ifndef EGT_ASIO_WRITE_HPP
#define EGT_ASIO_WRITE_HPP
 ...
 * @code egt::asio::write(s, egt::asio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::write(s, egt::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::write(s, egt::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write egt::asio::async_write
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * egt::asio::async_write(s, egt::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
#include <egt/asio/impl/write.hpp>

#endif // EGT_ASIO_WRITE_HPP
