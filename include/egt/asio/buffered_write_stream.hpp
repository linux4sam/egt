...
#ifndef EGT_ASIO_BUFFERED_WRITE_STREAM_HPP
#define EGT_ASIO_BUFFERED_WRITE_STREAM_HPP
...
public:
  ...
  /// error occurred.
  std::size_t flush(egt::asio::error_code& ec);

  /// Start an asynchronous flush.
  template <typename WriteHandler>
  EGT_ASIO_INITFN_RESULT_TYPE(WriteHandler,
      void (egt::asio::error_code, std::size_t))
  async_flush(EGT_ASIO_MOVE_ARG(WriteHandler) handler);
...
#include <egt/asio/impl/buffered_write_stream.hpp>

#endif // EGT_ASIO_BUFFERED_WRITE_STREAM_HPP
