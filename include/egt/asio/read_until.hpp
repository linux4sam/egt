...
#ifndef EGT_ASIO_READ_UNTIL_HPP
#define EGT_ASIO_READ_UNTIL_HPP
...
#include <egt/asio/detail/regex_fwd.hpp>
...
# include <egt/asio/basic_streambuf_fwd.hpp>
...
struct is_match_condition
{
  ...
  enum
  {
    value = egt::asio::is_function<
        typename egt::asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until egt::asio::read_until
 *
 ...
 * std::string n = egt::asio::read_until(s,
 *     egt::asio::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    EGT_ASIO_MOVE_ARG(DynamicBuffer) buffers, char delim);
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, egt::asio::error_code& ec);
...
std::size_t read_until(SyncReadStream& s,
    EGT_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    EGT_ASIO_STRING_VIEW_PARAM delim);
 ...
 * @code std::string data;
 * std::string n = egt::asio::read_until(s,
 *     egt::asio::dynamic_buffer(data), boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
std::size_t read_until(SyncReadStream& s,
    EGT_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    const boost::regex& expr, egt::asio::error_code& ec);
 ...
 * @code typedef egt::asio::buffers_iterator<
 *     egt::asio::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * egt::asio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * egt::asio::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    EGT_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    MatchCondition match_condition, egt::asio::error_code& ec,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);
 ...
 * @code egt::asio::streambuf b;
 * egt::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    egt::asio::basic_streambuf<Allocator>& b, char delim);
...
std::size_t read_until(SyncReadStream& s,
    egt::asio::basic_streambuf<Allocator>& b,
    EGT_ASIO_STRING_VIEW_PARAM delim, egt::asio::error_code& ec);
 ...
 * @code egt::asio::streambuf b;
 * egt::asio::read_until(s, b, boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    egt::asio::basic_streambuf<Allocator>& b, const boost::regex& expr);
 ...
 * @code typedef egt::asio::buffers_iterator<
 *     egt::asio::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * }
 * ...
 * egt::asio::streambuf b;
 * egt::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * egt::asio::streambuf b;
 * egt::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    egt::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);
...
/*@}*/
/**
 * @defgroup async_read_until egt::asio::async_read_until
 *
 ...
 * @code std::string data;
 * ...
 * void handler(const egt::asio::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::string line = data.substr(0, n);
 ...
 * }
 * ...
 * egt::asio::async_read_until(s, data, '\n', handler); @endcode
...
async_read_until(AsyncReadStream& s,
    EGT_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    char delim, EGT_ASIO_MOVE_ARG(ReadHandler) handler);
 ...
 * ...
 * std::string data;
 * egt::asio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * egt::asio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 */
...
async_read_until(AsyncReadStream& s,
    EGT_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    MatchCondition match_condition, EGT_ASIO_MOVE_ARG(ReadHandler) handler,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);
 ...
 * }
 * ...
 * egt::asio::async_read_until(s, b, boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * egt::asio::streambuf b;
 * egt::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * egt::asio::streambuf b;
 * egt::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
...
#include <egt/asio/impl/read_until.hpp>

#endif // EGT_ASIO_READ_UNTIL_HPP
