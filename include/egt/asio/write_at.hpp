...
#ifndef EGT_ASIO_WRITE_AT_HPP
#define EGT_ASIO_WRITE_AT_HPP
...
/**
 * @defgroup write_at egt::asio::write_at
 *
 ...
 * @code egt::asio::write_at(d, 42, egt::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code egt::asio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::write_at(d, 42, egt::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at egt::asio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * egt::asio::async_write_at(d, 42, egt::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code egt::asio::async_write_at(d, 42,
...
EGT_ASIO_INITFN_RESULT_TYPE(WriteHandler,
    void (egt::asio::error_code, std::size_t))
async_write_at(AsyncRandomAccessWriteDevice& d, uint64_t offset,
    basic_streambuf<Allocator>& b, EGT_ASIO_MOVE_ARG(WriteHandler) handler);
...
#include <egt/asio/impl/write_at.hpp>

#endif // EGT_ASIO_WRITE_AT_HPP
