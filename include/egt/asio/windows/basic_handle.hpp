...
#ifndef EGT_ASIO_WINDOWS_BASIC_HANDLE_HPP
#define EGT_ASIO_WINDOWS_BASIC_HANDLE_HPP
...
#include <egt/asio/detail/config.hpp>
  ...
  || defined(EGT_ASIO_HAS_WINDOWS_OBJECT_HANDLE) \
...
public:
   ...
   */
  explicit basic_handle(egt::asio::io_context& io_context)
   ...
   */
  basic_handle(egt::asio::io_context& io_context,
  ...
  basic_handle(basic_handle&& other)
    : basic_io_object<HandleService>(
        EGT_ASIO_MOVE_CAST(basic_handle)(other))
  {
  }
...
#endif // EGT_ASIO_WINDOWS_BASIC_HANDLE_HPP
