...
#ifndef EGT_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
#define EGT_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
...
public:
   ...
   */
  explicit basic_object_handle(egt::asio::io_context& io_context)
   ...
   */
  basic_object_handle(egt::asio::io_context& io_context,
  ...
  basic_object_handle(basic_object_handle&& other)
    : basic_handle<ObjectHandleService>(
        EGT_ASIO_MOVE_CAST(basic_object_handle)(other))
  {
  }
...
#endif // EGT_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
