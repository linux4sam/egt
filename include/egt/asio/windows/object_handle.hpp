...
#ifndef EGT_ASIO_WINDOWS_OBJECT_HANDLE_HPP
#define EGT_ASIO_WINDOWS_OBJECT_HANDLE_HPP
...
#define EGT_ASIO_SVC_T egt::asio::detail::win_object_handle_service
...
public:
   ...
   */
  explicit object_handle(egt::asio::io_context& io_context)
   ...
   */
  object_handle(egt::asio::io_context& io_context,
   ...
   */
  EGT_ASIO_SYNC_OP_VOID assign(const native_handle_type& handle,
      egt::asio::error_code& ec)
  {
    this->get_service().assign(this->get_implementation(), handle, ec);
  ...
  {
    egt::asio::async_completion<WaitHandler,
...
#endif // EGT_ASIO_WINDOWS_OBJECT_HANDLE_HPP
