...
#ifndef EGT_ASIO_WINDOWS_RANDOM_ACCESS_HANDLE_HPP
#define EGT_ASIO_WINDOWS_RANDOM_ACCESS_HANDLE_HPP
...
public:
   ...
   * handle.
   */
  explicit random_access_handle(egt::asio::io_context& io_context)
   ...
   */
  random_access_handle(egt::asio::io_context& io_context,
...
#endif // EGT_ASIO_WINDOWS_RANDOM_ACCESS_HANDLE_HPP
