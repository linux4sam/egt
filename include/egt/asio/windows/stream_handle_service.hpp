...
#ifndef EGT_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
#define EGT_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
...
#else
  : public egt::asio::detail::service_base<stream_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_handle_service(egt::asio::io_context& io_context)
    : egt::asio::detail::service_base<stream_handle_service>(io_context),
...
#endif // EGT_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
