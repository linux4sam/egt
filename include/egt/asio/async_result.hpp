...
#ifndef EGT_ASIO_ASYNC_RESULT_HPP
#define EGT_ASIO_ASYNC_RESULT_HPP
...
struct async_completion
{
  ...
  typedef typename egt::asio::async_result<
...
# define EGT_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  void_or_deduced
#elif defined(_MSC_VER) && (_MSC_VER < 1500)
# define EGT_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::egt::asio::detail::async_result_helper< \
    ct, sig>::return_type
#define EGT_ASIO_HANDLER_TYPE(ct, sig) \
  typename ::egt::asio::detail::async_result_helper< \
    ct, sig>::completion_handler_type
#else
# define EGT_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::egt::asio::async_result< \
    typename ::egt::asio::decay<ct>::type, sig>::return_type
#define EGT_ASIO_HANDLER_TYPE(ct, sig) \
  typename ::egt::asio::async_result< \
    typename ::egt::asio::decay<ct>::type, sig>::completion_handler_type
#endif

#endif // EGT_ASIO_ASYNC_RESULT_HPP
