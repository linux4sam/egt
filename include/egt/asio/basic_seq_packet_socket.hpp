...
#ifndef EGT_ASIO_BASIC_SEQ_PACKET_SOCKET_HPP
#define EGT_ASIO_BASIC_SEQ_PACKET_SOCKET_HPP
...
template <typename Protocol
    EGT_ASIO_SVC_TPARAM_DEF1(= seq_packet_socket_service<Protocol>)>
...
public:
   ...
   * the socket.
   */
  explicit basic_seq_packet_socket(egt::asio::io_context& io_context)
   ...
   */
  basic_seq_packet_socket(egt::asio::io_context& io_context,
  ...
  basic_seq_packet_socket(
      basic_seq_packet_socket<Protocol1 EGT_ASIO_SVC_TARG1>&& other,
   ...
   * follows:
   * @code
   * socket.receive(egt::asio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(egt::asio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(egt::asio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // EGT_ASIO_BASIC_SEQ_PACKET_SOCKET_HPP
