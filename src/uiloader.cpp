...
{
    {"egt::v1::experimental::Radial<int>", create_widget<Radial<int>>},
    {"egt::v1::experimental::Radial<float>", create_widget<Radial<float>>},
    {"egt::v1::AnalogMeter<int>", create_widget<AnalogMeter<int>>},
    {"egt::v1::AnalogMeter<float>", create_widget<AnalogMeter<float>>},
    ...
    {"egt::v1::LevelMeter<int>", create_widget<LevelMeter<int>>},
    {"egt::v1::LevelMeter<float>", create_widget<LevelMeter<float>>},
    ...
    {"egt::v1::ProgressBar<int>", create_widget<ProgressBar<int>>},
    {"egt::v1::ProgressBar<float>", create_widget<ProgressBar<float>>},
    ...
    {"egt::v1::SpinProgress<int>", create_widget<SpinProgress<int>>},
    {"egt::v1::SpinProgress<float>", create_widget<SpinProgress<float>>},
